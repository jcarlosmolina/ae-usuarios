...
import com.keralty.usuarios.repository.LogInformacionAsesorJpaRepository;
...
public class LogInformacionAsesorService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.loginformacionasesor.ds.DSLogInformacionAsesor getDSLogInformacionAsesor(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.loginformacionasesor.ds.DSLogInformacionAsesor(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.loginformacionasesor.ds.DSLogInformacionAsesor> piuPIULogInformacionAsesor(QueryRequest queryRequest) {
        return solveLogInformacionAsesorTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.loginformacionasesor.ds.DSLogInformacionAsesor::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse crear(
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.CrearRequest request) {
    ...
    public ServiceResponse crearTxn(
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.CrearRequest request) throws ModelException {
    ...
    public ServiceResponse eliminar(
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.EliminarRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse eliminarTxn(
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.EliminarRequest request) throws ModelException {
    ...
    public ServiceResponse tNEW(
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.TNEWRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tNEWTxn(
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.TNEWRequest request) throws ModelException {
    ...
    public ServiceResponse tNEWImplementation(
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.CrearRequest step10Request = new com.keralty.usuarios.viewmodel.loginformacionasesor.siu.CrearRequest();
            ...
            com.keralty.usuarios.viewmodel.loginformacionasesor.siu.CrearRequest step11Request = new com.keralty.usuarios.viewmodel.loginformacionasesor.siu.CrearRequest();
