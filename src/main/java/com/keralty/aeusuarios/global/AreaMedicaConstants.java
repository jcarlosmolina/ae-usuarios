...
/**
 * Class with the constants relative to the <code>AreaMedica</code> model class.
 */
public final class AreaMedicaConstants {

    private AreaMedicaConstants() {

    }

    // Class
    /** <code>AreaMedica</code> class id. */
    public static final String CLASS_ID = "Clas_1434549485568029_Alias";
    /** <code>AreaMedica</code> class name. */
    public static final String CLASS_NAME = "AreaMedica";
    /** <code>AreaMedica</code> class alias. */
    public static final String CLASS_ALIAS = "Área médica";
    /** <code>AreaMedica</code> class table name. */
    public static final String TBL_NAME = "AreaMedica";

    // Default DisplaySet
    public static final String DEFAULT_DISPLAYSET = "funcionarioId,passWord";

    public static final String DSSIAREAMEDICA = "SIAreaMedica";
    ...
    public static final String ROLE_ID_SOLICITUDESARME = "Agr_1517848625152064_Alias";
    /** <code>SolicitudesArMe</code> role name. */
    public static final String ROLE_NAME_SOLICITUDESARME = "solicitudesArMe";
    /** <code>UsrAreaMedica</code> role alias. */
    public static final String ROLE_ALIAS_SOLICITUDESARME = "Solicitudes";
    ...
    public static final String PATH_FACETS_SOLICITUDESARME = "";
    ...
    /** Agents allowed to navigate through SolicitudesArMe **/
    public static final String SOLICITUDESARME_AGENTS = "Admin,SuperAdmin,Asesor,AreaMedica,Afiliaciones,MesaDeApoyo";
    ...
    public static final String SERV_ID_INSUSRAREAMEDICA = "Clas_1434549485568029Ser_1_Alias";
    ...
    // Inbound arguments
    /** <code>areaMedicaInsUsrAreaMedicapthisAreaMedica</code> inbound argument name. */
    public static final String ARG_NAME_INSUSRAREAMEDICA_AREAMEDICAINSUSRAREAMEDICAPTHISAREAMEDICA = "p_thisAreaMedica";
    /** <code>areaMedicaInsUsrAreaMedicapthisAreaMedica</code> inbound argument id. */
    public static final String ARG_ID_INSUSRAREAMEDICA_AREAMEDICAINSUSRAREAMEDICAPTHISAREAMEDICA = "Clas_1434549485568029Ser_1Arg_1_Alias";
    /** <code>areaMedicaInsUsrAreaMedicapthisAreaMedica</code> inbound argument alias. */
    public static final String ARG_ALIAS_INSUSRAREAMEDICA_AREAMEDICAINSUSRAREAMEDICAPTHISAREAMEDICA = "Usr. Area Médica";
    /** <code>areaMedicaInsUsrAreaMedicapevcSolicitud</code> inbound argument name. */
    public static final String ARG_NAME_INSUSRAREAMEDICA_AREAMEDICAINSUSRAREAMEDICAPEVCSOLICITUD = "p_evcSolicitud";
    /** <code>areaMedicaInsUsrAreaMedicapevcSolicitud</code> inbound argument id. */
    public static final String ARG_ID_INSUSRAREAMEDICA_AREAMEDICAINSUSRAREAMEDICAPEVCSOLICITUD = "Clas_1434549485568029Ser_1Arg_2_Alias";
    /** <code>areaMedicaInsUsrAreaMedicapevcSolicitud</code> inbound argument alias. */
    public static final String ARG_ALIAS_INSUSRAREAMEDICA_AREAMEDICAINSUSRAREAMEDICAPEVCSOLICITUD = "Solicitudes";
    // Service (DelUsrAreaMedica)
    /** <code>DelUsrAreaMedica</code> service id. */
    public static final String SERV_ID_DELUSRAREAMEDICA = "Clas_1434549485568029Ser_2_Alias";
    ...
    // Inbound arguments
    /** <code>areaMedicaDelUsrAreaMedicapthisAreaMedica</code> inbound argument name. */
    public static final String ARG_NAME_DELUSRAREAMEDICA_AREAMEDICADELUSRAREAMEDICAPTHISAREAMEDICA = "p_thisAreaMedica";
    /** <code>areaMedicaDelUsrAreaMedicapthisAreaMedica</code> inbound argument id. */
    public static final String ARG_ID_DELUSRAREAMEDICA_AREAMEDICADELUSRAREAMEDICAPTHISAREAMEDICA = "Clas_1434549485568029Ser_2Arg_1_Alias";
    /** <code>areaMedicaDelUsrAreaMedicapthisAreaMedica</code> inbound argument alias. */
    public static final String ARG_ALIAS_DELUSRAREAMEDICA_AREAMEDICADELUSRAREAMEDICAPTHISAREAMEDICA = "Usr. Area Médica";
    /** <code>areaMedicaDelUsrAreaMedicapevcSolicitud</code> inbound argument name. */
    public static final String ARG_NAME_DELUSRAREAMEDICA_AREAMEDICADELUSRAREAMEDICAPEVCSOLICITUD = "p_evcSolicitud";
    /** <code>areaMedicaDelUsrAreaMedicapevcSolicitud</code> inbound argument id. */
    public static final String ARG_ID_DELUSRAREAMEDICA_AREAMEDICADELUSRAREAMEDICAPEVCSOLICITUD = "Clas_1434549485568029Ser_2Arg_2_Alias";
    /** <code>areaMedicaDelUsrAreaMedicapevcSolicitud</code> inbound argument alias. */
    public static final String ARG_ALIAS_DELUSRAREAMEDICA_AREAMEDICADELUSRAREAMEDICAPEVCSOLICITUD = "Solicitudes";
    // Service (changePassword)
    /** <code>changePassword</code> service id. */
    public static final String SERV_ID_CHANGEP4SSW0RD = "Clas_1434549485568029Ser_4B_Alias";
    ...
    // Inbound arguments
    /** <code>areaMedicachangePasswordpthisAdmin</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPTHISADMIN = "p_thisAdmin";
    /** <code>areaMedicachangePasswordpthisAdmin</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPTHISADMIN = "Clas_1431626842112800Ser_4Arg_1B_Alias";
    /** <code>areaMedicachangePasswordpthisAdmin</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPTHISADMIN = "Usuario";
    /** <code>areaMedicachangePasswordpOldPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPOLDP4SSW0RD = "p_OldPassword";
    /** <code>areaMedicachangePasswordpOldPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPOLDP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>areaMedicachangePasswordpOldPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPOLDP4SSW0RD = "Old password";
    /** <code>areaMedicachangePasswordpNewPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPNEWP4SSW0RD = "p_NewPassword";
    /** <code>areaMedicachangePasswordpNewPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPNEWP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>areaMedicachangePasswordpNewPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_AREAMEDICACHANGEP4SSW0RDPNEWP4SSW0RD = "Nueva contraseña";
     ...
     * - If className is 'AreaMedica', it returns the identification keys
     * - If className is a facet of the inheritance net of 'AreaMedica', it returns the foreign keys to the table of the facet className
