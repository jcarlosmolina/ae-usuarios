...
import com.keralty.aeusuarios.repository.AreaMedicaJpaRepository;
...
/**
 * Persistent representation of the <code>AreaMedica</code> model class.
 * <p>
 * Model Class: <code>AreaMedica</code><br>
 */
@Entity(name = AreaMedicaConstants.CLASS_NAME)
@Table(name = AreaMedicaConstants.TBL_NAME)
public class AreaMedica extends AbstractAppEntity {
    @JsonIgnore
    ...
    @Id
    @Column(name = AreaMedicaConstants.FLD_FUNCIONARIOID, insertable = false, updatable = false )
    @JsonProperty(value="id")
    private Long funcionarioId;

    @Column(name = AreaMedicaConstants.FLD_P4SSW0RD )
    ...
    /** Related Class. */
    @OneToMany(mappedBy = AreaMedicaConstants.ROLE_INVNAME_SOLICITUDESARME)
    @JsonIgnore
    private Collection <Solicitud> solicitudesArMe;
    /** Related Class modified. */
    @Transient
    @JsonIgnore
    private boolean modifiedSolicitudesArMe;

    /** Class member parent. */
    @OneToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL)
    @JoinColumns({
        @JoinColumn(name=AreaMedicaConstants.FLD_FUNCIONARIOID, referencedColumnName=FuncionarioConstants.FLD_FUNCIONARIOID)
    })
    @JsonIgnore
    ...
    */
    ...
    /**
     * Constructor used to create instances of <code>AreaMedica</code>.
     * @param oid Object Identifier of the instance of <code>AreaMedica</code> to be created.
     * @throws SystemException
     */
    public AreaMedica(AreaMedicaOid oid) {
    ...
    */
    ...
    public Boolean getAreaMedicaManual()  {
    ...
    */
    ...
    public String getAreaMedicaUsuario()  {
    ...
    */
    ...
    public String getAreaMedicaPrimerNombre()  {
    ...
    */
    ...
    public String getAreaMedicaSegundoNombre()  {
    ...
    */
    ...
    public String getAreaMedicaPrimerApellido()  {
    ...
    */
    ...
    public String getAreaMedicaSegundoApellido()  {
    ...
    */
    ...
    public String getAreaMedicaDrvNombreCompleto()  {
    ...
    */
    ...
    public String getAreaMedicaUsuarioLDAP()  {
    ...
    */
    ...
    public String getAreaMedicaEmail()  {
    ...
    */
    ...
    public String getAreaMedicaCodJefe()  {
    ...
    */
    ...
    public String getAreaMedicaDrvNomJefe()  {
    ...
    */
    ...
    public String getAreaMedicaDrvNomAgencia()  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getAreaMedicaDisponible()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Long getAreaMedicaNumSolNoTerminadas()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Boolean getAreaMedicaDrvEsAsesorIntegral()  {
    ...
    */
    ...
    public Boolean getAreaMedicaDrvEsAfiliacion()  {
    ...
    */
    ...
    public Boolean getAreaMedicaModDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getAreaMedicaModificaDirector() throws SystemException  {
    ...
    */
    ...
    public Boolean getAreaMedicaEsDirector() throws SystemException  {
    ...
    */
    ...
    public String getAreaMedicaNumIdentificacion() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getAreaMedicaEsIntegral() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getAreaMedicaVerDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getAreaMedicaVerDocIdentificacionPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getAreaMedicaVerContratoNovedad() throws SystemException  {
    ...
    */
    ...
    public String getAreaMedicaCanalComercial() throws SystemException  {
    ...
    */
    ...
    public String getAreaMedicaCargo() throws SystemException  {
    ...
    */
    ...
    public String getAreaMedicaEstado() throws SystemException  {
    ...
    */
    ...
    public Boolean getAreaMedicaAccesoValidadorUsuarios() throws SystemException  {
    ...
    */
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesArMe 0:M  ------ 0:1  UsrAreaMedica [AreaMedica]</code>
     *
    ...
    public Collection <Solicitud> getSolicitudesArMe() {
        return solicitudesArMe;
    }

   /**
    * Adds an instance of <code>Solicitud</code> related through the <code>SolicitudesArMe</code> role.
    * @param solicitudesArMe The instance to add to the <code>SolicitudesArMe</code> role.
    */
    public void add2SolicitudesArMe(Solicitud solicitudesArMe) {
        this.getSolicitudesArMe().add(solicitudesArMe);
    }
    /**
     * Sets instances of <code>Solicitud</code> related through the <code>SolicitudesArMe</code> role.
     * @param solicitudesArMe The new value for the <code>SolicitudesArMe</code> role.
     */
    public void setSolicitudesArMe(Collection < Solicitud > solicitudesArMe) {
        this.solicitudesArMe = solicitudesArMe;
    }

   /**
    * This method gets the attribute value <code>modifiedSolicitudesArMe</code> has been modified.
    * @return a boolean value that indicates if the attribute <code>modifiedSolicitudesArMe</code> has been modified.
    */
    public boolean isModifiedSolicitudesArMe(){
        return modifiedSolicitudesArMe;
    }

    /**
     * Returns the instance of <code>Solicitud</code> related through the <code>Solicitudes</code> role.
     * Model Relationship:
     * <code>[Solicitud] Solicitudes 0:M  ------ 1:1  Agente [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesAfiliacion 0:M  ------ 0:1  UsrAfiliacion [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ReportesProcAlm] Reportes 0:M  ------ 0:M  Funcionarios [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolicitudesNovedad 0:M  ------ 1:1  Agente [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolNovAifliaciones 0:M  ------ 0:1  UsrAfiliacion [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[GrupoAsignacion] GrupoAsignacion 0:M  ------ 0:M  Funcionario [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogFuncionario] LogFuncionario 0:M  ------ 1:1  Funcionario [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ContratoC] ContratosC 0:M  ------ 0:1  AsesorC [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[AgentexProducto] AgentexProducto 0:M  ------ 1:1  Asesor [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogInformacionAsesor] LogInformacionAsesor 0:M  ------ 1:1  Asesor [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogHistoricoPlanes] LogHistoricoPlanes 0:M  ------ 1:1  Asesor [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Firma] Firma 0:1  ------ 0:1  RespRegional [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Rol] Rol 1:1  ------ 0:M  Agentes [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Sucursal] Sucursal 1:1  ------ 0:M  Agentes [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[TipoIdentificacion] TipoIdentificacion 0:1  ------ 0:M  Asesores [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Planes] Planes 0:M  ------ 0:M  Afiliaciones [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Regional] Regional 0:1  ------ 0:1  RespRegional [AreaMedica]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
    ...
    public Funcionario getParentFuncionario() {
        if (!parentFuncionarioInitialized) {
            setParentFuncionario(areaMedicaRepository.findParent(getFuncionarioId()));
        }
    ...
    protected Method[] getMethods() {
    	return AreaMedica.class.getMethods();
    }
    ...
    protected String getClassAttributeType(String attribute) {
    	return AreaMedicaConstants.ATTRIBUTE_TYPES.get(attribute.toUpperCase());
    }
    ...
    */
    ...
    /**
     * Returns the <code>AreaMedicaOid</code> object that identifies this instance of <code>AreaMedica</code>.
     * @return <code>AreaMedicaOid </code> object that identifies this instance of <code>AreaMedica</code>
     */
    public AreaMedicaOid getOid() {
        return new AreaMedicaOid(getFuncionarioId());
    }

    
    @Override
    protected boolean isAttributeVisible(String item) {
        return getAgent().isAnyFacetActive(AreaMedicaConstants.ATTRIBUTE_AGENTS.get(item.toUpperCase()));
    }


    @Override
    protected boolean isRelatedItemVerticallyVisible(String item) {
        return getSerCtx().getAgent().isAnyFacetActive(AreaMedicaConstants.ROLE_AGENTS.get(item.toUpperCase()));
    }
    ...
    public List<String> getFacets() {
        ...
        if (!activeFacets.contains(Constants.AREAMEDICA)) {
            // Add this class
            activeFacets.add(Constants.AREAMEDICA);
        }
        return activeFacets;
    }
    ...
    */
    ...
    public String buildSIAreaMedica() {
        try {
            return getFuncionarioUsuarioLDAP();
        } catch(Exception e) {
            return "";
