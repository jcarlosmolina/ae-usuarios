...
public class AfiliacionesService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.afiliaciones.ds.SIAfiliaciones getSIAfiliaciones(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.afiliaciones.ds.SIAfiliaciones(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliaciones getDSAfiliaciones(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Afiliaciones instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliaciones(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliacionesMPlanes getDSAfiliacionesMPlanes(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Afiliaciones instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliacionesMPlanes(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliacionesMPlanes iIUAfiliacionesMPlanes(AfiliacionesOid oid) {
        return new com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliacionesMPlanes(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliaciones> piuPIUAfiliaciones(QueryRequest queryRequest) {
        return solveAfiliacionesTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.afiliaciones.ds.DSAfiliaciones::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse insPlan(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.InsPlanRequest request) {
    ...
    public ServiceResponse insPlanTxn(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.InsPlanRequest request) throws ModelException {
    ...
    public ServiceResponse insPlanImplementation(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.InsPlanRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.planes.siu.InsPlanRequest relatedRequest = new com.keralty.usuarios.viewmodel.planes.siu.InsPlanRequest();
    ...
    public ServiceResponse delPlan(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.DelPlanRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delPlanTxn(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.DelPlanRequest request) throws ModelException {
    ...
    public ServiceResponse delPlanImplementation(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.DelPlanRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.planes.siu.DelPlanRequest relatedRequest = new com.keralty.usuarios.viewmodel.planes.siu.DelPlanRequest();
    ...
    public ServiceResponse changePassword(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.ChangePasswordRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse changePasswordTxn(
            com.keralty.usuarios.viewmodel.afiliaciones.siu.ChangePasswordRequest request) throws ModelException {
