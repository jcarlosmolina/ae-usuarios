package com.keralty.usuarios.api.globalservices;

import com.keralty.usuarios.service.GlobalServicesService;
import com.keralty.usuarios.utils.TokenUtilities;
import com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse;
import com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse;
import com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCAGENTESXPRODRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCASESORESRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TCREARAGENTERequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGMODASESORAGENCIARequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIARequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGPOSPROCESARASESORESRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODAUXRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCPRODUCTOSRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCSUCURSALESRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCTIPOSIDENTIFICACIONRequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TGVERIFICARUSUARIORequest;
import com.keralty.usuarios.viewmodel.globalservices.siu.TMODIFICARAGENTERequest;
