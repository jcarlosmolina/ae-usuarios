...
import com.keralty.usuarios.viewmodel.planes.crud.PlanesPostViewModel;
import com.keralty.usuarios.viewmodel.planes.crud.PlanesPutViewModel;
...
public class PlanesService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.planes.ds.ICPlan getICPlan(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.planes.ds.ICPlan(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.planes.ds.DSPlanPIU getDSPlanPIU(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Planes instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.planes.ds.DSPlanPIU(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.planes.ds.DSPlanesDAfiliacion getDSPlanesDAfiliacion(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Planes instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.planes.ds.DSPlanesDAfiliacion(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.planes.ds.DSPlanPIU> piuPIUPlan(QueryRequest queryRequest) {
        return solvePlanesTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.planes.ds.DSPlanPIU::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.planes.ds.DSPlanesDAfiliacion> piuPIUPlanesDAfiliacion(QueryRequest queryRequest) {
        return solvePlanesTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.planes.ds.DSPlanesDAfiliacion::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse insPlan(
            com.keralty.usuarios.viewmodel.planes.siu.InsPlanRequest request) {
    ...
    public ServiceResponse insPlanTxn(
            com.keralty.usuarios.viewmodel.planes.siu.InsPlanRequest request) throws ModelException {
    ...
    public ServiceResponse insPlanImplementation(
            com.keralty.usuarios.viewmodel.planes.siu.InsPlanRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.afiliaciones.siu.InsPlanRequest relatedRequest = new com.keralty.usuarios.viewmodel.afiliaciones.siu.InsPlanRequest();
    ...
    public ServiceResponse delPlan(
            com.keralty.usuarios.viewmodel.planes.siu.DelPlanRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delPlanTxn(
            com.keralty.usuarios.viewmodel.planes.siu.DelPlanRequest request) throws ModelException {
    ...
    public ServiceResponse delPlanImplementation(
            com.keralty.usuarios.viewmodel.planes.siu.DelPlanRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.afiliaciones.siu.DelPlanRequest relatedRequest = new com.keralty.usuarios.viewmodel.afiliaciones.siu.DelPlanRequest();
