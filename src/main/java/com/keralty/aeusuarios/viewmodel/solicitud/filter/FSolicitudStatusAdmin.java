...
public class FSolicitudStatusAdmin {
    ...
    public FilterRequest buildFilterRequest() {
        ...
        filterRequest.setName(SolicitudConstants.FILTER_NAME_FSOLICITUDSTATUSADMIN);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VNUMSOLICITUD, vNumSolicitud);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VTRAMITE, vTramite);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VOPRODUCTO, voProducto);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VOPLAN, voPlan);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VOESTADO, voEstado);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VFELABINI, vFElabIni);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VFELABFIN, vFElabFin);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VFCONTRATOINI, vFContratoIni);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VFCONTRATOFIN, vFContratoFin);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VCODASESOR, vCodAsesor);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VTIPODOC, vTipoDoc);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VNUMDOC, vNumDoc);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VOREGIONAL, voRegional);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSADMIN_VESTADODOC, vEstadoDoc);
