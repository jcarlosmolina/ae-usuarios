...
import com.keralty.usuarios.repository.AdminJpaRepository;
...
/**
 * Persistent representation of the <code>Admin</code> model class.
 * <p>
 * Model Class: <code>Admin</code><br>
 */
@Entity(name = AdminConstants.CLASS_NAME)
@Table(name = AdminConstants.TBL_NAME)
public class Admin extends AbstractAppEntity {
    @JsonIgnore
    private static final long serialVersionUID = 1L;

    @JsonIgnore
    private transient AdminJpaRepository adminRepository;

    /** Class identification function. */
    @Id
    @Column(name = AdminConstants.FLD_FUNCIONARIOID, insertable = false, updatable = false )
    @JsonProperty(value="id")
    private Long funcionarioId;

    @Column(name = AdminConstants.FLD_P4SSW0RD )
    ...
    @JoinColumns({
        @JoinColumn(name=AdminConstants.FLD_FUNCIONARIOID, referencedColumnName=FuncionarioConstants.FLD_FUNCIONARIOID)
    })
    @JsonIgnore
    ...
    */
    ...
    /**
     * Constructor used to create instances of <code>Admin</code>.
     * @param oid Object Identifier of the instance of <code>Admin</code> to be created.
     * @throws SystemException
     */
    public Admin(AdminOid oid) {
    ...
    */
    ...
    public String getAdminDrvNombreCompleto()  {
    ...
    */
    ...
    public String getAdminUsuarioLDAP()  {
    ...
    */
    ...
    public String getAdminDrvNomJefe()  {
    ...
    */
    ...
    public String getAdminDrvNomAgencia()  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getAdminDisponible()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Long getAdminNumSolNoTerminadas()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Boolean getAdminDrvEsAsesorIntegral()  {
    ...
    */
    ...
    public Boolean getAdminDrvEsAfiliacion()  {
    ...
    */
    ...
    public Boolean getAdminModDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getAdminModificaDirector() throws SystemException  {
    ...
    */
    ...
    public Boolean getAdminEsDirector() throws SystemException  {
    ...
    */
    ...
    public String getAdminNumIdentificacion() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getAdminEsIntegral() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getAdminVerDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getAdminVerDocIdentificacionPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getAdminVerContratoNovedad() throws SystemException  {
    ...
    */
    ...
    public String getAdminCanalComercial() throws SystemException  {
    ...
    */
    ...
    public String getAdminCargo() throws SystemException  {
    ...
    */
    ...
    public String getAdminEstado() throws SystemException  {
    ...
    */
    ...
    public Boolean getAdminAccesoValidadorUsuarios() throws SystemException  {
    ...
    */
     ...
     * Model Relationship:
     * <code>[Solicitud] Solicitudes 0:M  ------ 1:1  Agente [Admin]</code>
     *
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesAfiliacion 0:M  ------ 0:1  UsrAfiliacion [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ReportesProcAlm] Reportes 0:M  ------ 0:M  Funcionarios [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolicitudesNovedad 0:M  ------ 1:1  Agente [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolNovAifliaciones 0:M  ------ 0:1  UsrAfiliacion [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[GrupoAsignacion] GrupoAsignacion 0:M  ------ 0:M  Funcionario [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogFuncionario] LogFuncionario 0:M  ------ 1:1  Funcionario [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ContratoC] ContratosC 0:M  ------ 0:1  AsesorC [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[AgentexProducto] AgentexProducto 0:M  ------ 1:1  Asesor [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogInformacionAsesor] LogInformacionAsesor 0:M  ------ 1:1  Asesor [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogHistoricoPlanes] LogHistoricoPlanes 0:M  ------ 1:1  Asesor [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesArMe 0:M  ------ 0:1  UsrAreaMedica [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Firma] Firma 0:1  ------ 0:1  RespRegional [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Rol] Rol 1:1  ------ 0:M  Agentes [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Sucursal] Sucursal 1:1  ------ 0:M  Agentes [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[TipoIdentificacion] TipoIdentificacion 0:1  ------ 0:M  Asesores [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Planes] Planes 0:M  ------ 0:M  Afiliaciones [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Regional] Regional 0:1  ------ 0:1  RespRegional [Admin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
    ...
    public Funcionario getParentFuncionario() {
        if (!parentFuncionarioInitialized) {
            setParentFuncionario(adminRepository.findParent(getFuncionarioId()));
        }
    ...
    private void initAttributes() {
        ...
        values = new HashMap<>();
        adminRepository = Arc.container().select(AdminJpaRepository.class).get();
    ...
    protected String getClassAttributeType(String attribute) {
    	return AdminConstants.ATTRIBUTE_TYPES.get(attribute.toUpperCase());
    }
    ...
    */
    ...
    /**
     * Returns the <code>AdminOid</code> object that identifies this instance of <code>Admin</code>.
     * @return <code>AdminOid </code> object that identifies this instance of <code>Admin</code>
     */
    public AdminOid getOid() {
        return new AdminOid(getFuncionarioId());
    }

    
    @Override
    protected boolean isAttributeVisible(String item) {
        return getAgent().isAnyFacetActive(AdminConstants.ATTRIBUTE_AGENTS.get(item.toUpperCase()));
    }


    @Override
    protected boolean isRelatedItemVerticallyVisible(String item) {
        return getSerCtx().getAgent().isAnyFacetActive(AdminConstants.ROLE_AGENTS.get(item.toUpperCase()));
    }
    ...
    public List<String> getFacets() {
        ...
        if (!activeFacets.contains(Constants.ADMIN)) {
            // Add this class
            activeFacets.add(Constants.ADMIN);
        }
        return activeFacets;
    }
