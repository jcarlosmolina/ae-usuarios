...
import com.keralty.usuarios.viewmodel.grupoasignacion.crud.GrupoAsignacionPostViewModel;
import com.keralty.usuarios.viewmodel.grupoasignacion.crud.GrupoAsignacionPutViewModel;
...
public class GrupoAsignacionService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion getDSGrupoAsignacion(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.grupoasignacion.ds.ICGrupoAsignacion getICGrupoAsignacion(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        GrupoAsignacion instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.grupoasignacion.ds.ICGrupoAsignacion(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.grupoasignacion.ds.AutoDS getAutoDS(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        GrupoAsignacion instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.grupoasignacion.ds.AutoDS(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion iIUGrupoMDominio(GrupoAsignacionOid oid) {
        return new com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion iIUGrupoMedicoMDominio(GrupoAsignacionOid oid) {
        return new com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion> piuPIUGrupoAsignacion(QueryRequest queryRequest) {
        return solveGrupoAsignacionTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.grupoasignacion.ds.DSGrupoAsignacion::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.grupoasignacion.ds.AutoDS> piuPIUGrupoAsignacion1(QueryRequest queryRequest) {
        return solveGrupoAsignacionTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.grupoasignacion.ds.AutoDS::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse addFuncionarioGrupo(
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.AddFuncionarioGrupoRequest request) {
    ...
    public ServiceResponse addFuncionarioGrupoTxn(
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.AddFuncionarioGrupoRequest request) throws ModelException {
    ...
    public ServiceResponse addFuncionarioGrupoImplementation(
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.AddFuncionarioGrupoRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.AddFuncionarioGrupoRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.AddFuncionarioGrupoRequest();
    ...
    public ServiceResponse delFuncionarioGrupo(
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.DelFuncionarioGrupoRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delFuncionarioGrupoTxn(
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.DelFuncionarioGrupoRequest request) throws ModelException {
    ...
    public ServiceResponse delFuncionarioGrupoImplementation(
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.DelFuncionarioGrupoRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DelFuncionarioGrupoRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.DelFuncionarioGrupoRequest();
