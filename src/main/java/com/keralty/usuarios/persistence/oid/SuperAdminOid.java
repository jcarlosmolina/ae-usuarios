...
public class SuperAdminOid implements IOid {
     ...
     */
    public SuperAdminOid(Long funcionarioId) {
     ...
     */
    public SuperAdminOid(List<Object> col) {
     ...
     */
    public SuperAdminOid(FuncionarioOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof SuperAdminOid)) {
            returnValue = false;
        } else {
            SuperAdminOid oid = (SuperAdminOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = SuperAdminConstants.ATTR_NAME_FUNCIONARIOID;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return SuperAdminConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        SuperAdminOid candidateOID = null;
        try {
            candidateOID = new SuperAdminOid((Long) instance[0]);
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public SuperAdminOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        SuperAdminOid temp;
        try {
            temp = mapper.readValue(jsonString, SuperAdminOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
