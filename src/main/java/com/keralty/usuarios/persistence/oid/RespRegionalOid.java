...
public class RespRegionalOid implements IOid {
     ...
     */
    public RespRegionalOid(Long funcionarioId) {
     ...
     */
    public RespRegionalOid(List<Object> col) {
     ...
     */
    public RespRegionalOid(FuncionarioOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof RespRegionalOid)) {
            returnValue = false;
        } else {
            RespRegionalOid oid = (RespRegionalOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = RespRegionalConstants.ATTR_NAME_FUNCIONARIOID;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return RespRegionalConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        RespRegionalOid candidateOID = null;
        try {
            candidateOID = new RespRegionalOid((Long) instance[0]);
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public RespRegionalOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        RespRegionalOid temp;
        try {
            temp = mapper.readValue(jsonString, RespRegionalOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
