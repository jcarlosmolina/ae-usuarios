...
import com.keralty.aeusuarios.repository.GestorJpaRepository;
...
/**
 * Persistent representation of the <code>Gestor</code> model class.
 * <p>
 * Model Class: <code>Gestor</code><br>
 */
@Entity(name = GestorConstants.CLASS_NAME)
@Table(name = GestorConstants.TBL_NAME)
public class Gestor extends AbstractAppEntity {
    @JsonIgnore
    private static final long serialVersionUID = 1L;

    @JsonIgnore
    private transient GestorJpaRepository gestorRepository;

    /** Class identification function. */
    @Id
    @Column(name = GestorConstants.FLD_FUNCIONARIOID, insertable = false, updatable = false )
    @JsonProperty(value="id")
    private Long funcionarioId;

    @Column(name = GestorConstants.FLD_P4SSW0RD )
    ...
    @JoinColumns({
        @JoinColumn(name=GestorConstants.FLD_FUNCIONARIOID, referencedColumnName=FuncionarioConstants.FLD_FUNCIONARIOID)
    })
    @JsonIgnore
    ...
    */
    ...
    /**
     * Constructor used to create instances of <code>Gestor</code>.
     * @param oid Object Identifier of the instance of <code>Gestor</code> to be created.
     * @throws SystemException
     */
    public Gestor(GestorOid oid) {
    ...
    */
    ...
    public Boolean getGestorManual()  {
    ...
    */
    ...
    public String getGestorUsuario()  {
    ...
    */
    ...
    public String getGestorPrimerNombre()  {
    ...
    */
    ...
    public String getGestorSegundoNombre()  {
    ...
    */
    ...
    public String getGestorPrimerApellido()  {
    ...
    */
    ...
    public String getGestorSegundoApellido()  {
    ...
    */
    ...
    public String getGestorDrvNombreCompleto()  {
    ...
    */
    ...
    public String getGestorUsuarioLDAP()  {
    ...
    */
    ...
    public String getGestorCodJefe()  {
    ...
    */
    ...
    public String getGestorDrvNomJefe()  {
    ...
    */
    ...
    public String getGestorDrvNomAgencia()  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getGestorDisponible()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Long getGestorNumSolNoTerminadas()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Boolean getGestorDrvEsAsesorIntegral()  {
    ...
    */
    ...
    public Boolean getGestorDrvEsAfiliacion()  {
    ...
    */
    ...
    public Boolean getGestorModDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getGestorModificaDirector() throws SystemException  {
    ...
    */
    ...
    public Boolean getGestorEsDirector() throws SystemException  {
    ...
    */
    ...
    public String getGestorNumIdentificacion() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getGestorEsIntegral() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getGestorVerDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getGestorVerDocIdentificacionPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getGestorVerContratoNovedad() throws SystemException  {
    ...
    */
    ...
    public String getGestorCanalComercial() throws SystemException  {
    ...
    */
    ...
    public String getGestorCargo() throws SystemException  {
    ...
    */
    ...
    public String getGestorEstado() throws SystemException  {
    ...
    */
    ...
    public Boolean getGestorAccesoValidadorUsuarios() throws SystemException  {
    ...
    */
     ...
     * Model Relationship:
     * <code>[Solicitud] Solicitudes 0:M  ------ 1:1  Agente [Gestor]</code>
     *
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesAfiliacion 0:M  ------ 0:1  UsrAfiliacion [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ReportesProcAlm] Reportes 0:M  ------ 0:M  Funcionarios [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolicitudesNovedad 0:M  ------ 1:1  Agente [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolNovAifliaciones 0:M  ------ 0:1  UsrAfiliacion [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[GrupoAsignacion] GrupoAsignacion 0:M  ------ 0:M  Funcionario [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogFuncionario] LogFuncionario 0:M  ------ 1:1  Funcionario [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ContratoC] ContratosC 0:M  ------ 0:1  AsesorC [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[AgentexProducto] AgentexProducto 0:M  ------ 1:1  Asesor [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogInformacionAsesor] LogInformacionAsesor 0:M  ------ 1:1  Asesor [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogHistoricoPlanes] LogHistoricoPlanes 0:M  ------ 1:1  Asesor [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesArMe 0:M  ------ 0:1  UsrAreaMedica [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Firma] Firma 0:1  ------ 0:1  RespRegional [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Rol] Rol 1:1  ------ 0:M  Agentes [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Sucursal] Sucursal 1:1  ------ 0:M  Agentes [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[TipoIdentificacion] TipoIdentificacion 0:1  ------ 0:M  Asesores [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Planes] Planes 0:M  ------ 0:M  Afiliaciones [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Regional] Regional 0:1  ------ 0:1  RespRegional [Gestor]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
    ...
    public Funcionario getParentFuncionario() {
        if (!parentFuncionarioInitialized) {
            setParentFuncionario(gestorRepository.findParent(getFuncionarioId()));
        }
    ...
    private void initAttributes() {
        ...
        values = new HashMap<>();
        gestorRepository = Arc.container().select(GestorJpaRepository.class).get();
    ...
    protected Method[] getMethods() {
    	return Gestor.class.getMethods();
    }
    ...
    protected String getClassAttributeType(String attribute) {
    	return GestorConstants.ATTRIBUTE_TYPES.get(attribute.toUpperCase());
    }
    ...
    */
    ...
    /**
     * Returns the <code>GestorOid</code> object that identifies this instance of <code>Gestor</code>.
     * @return <code>GestorOid </code> object that identifies this instance of <code>Gestor</code>
     */
    public GestorOid getOid() {
        return new GestorOid(getFuncionarioId());
    }

    
    @Override
    protected boolean isAttributeVisible(String item) {
        return getAgent().isAnyFacetActive(GestorConstants.ATTRIBUTE_AGENTS.get(item.toUpperCase()));
    }


    @Override
    protected boolean isRelatedItemVerticallyVisible(String item) {
        return getSerCtx().getAgent().isAnyFacetActive(GestorConstants.ROLE_AGENTS.get(item.toUpperCase()));
    }
    ...
    public List<String> getFacets() {
        ...
        if (!activeFacets.contains(Constants.GESTOR)) {
            // Add this class
            activeFacets.add(Constants.GESTOR);
        }
        return activeFacets;
    }
