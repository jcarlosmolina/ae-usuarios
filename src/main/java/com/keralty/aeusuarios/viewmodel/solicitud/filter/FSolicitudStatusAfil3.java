...
public class FSolicitudStatusAfil3 {
    ...
    public FilterRequest buildFilterRequest() {
        ...
        filterRequest.setName(SolicitudConstants.FILTER_NAME_FSOLICITUDSTATUSAFIL3);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VNUMSOLICITUD, vNumSolicitud);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VTRAMITE, vTramite);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VOPRODUCTO, voProducto);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VOPLAN, voPlan);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VOESTADO, voEstado);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VFELABINI, vFElabIni);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VFELABFIN, vFElabFin);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VFCONTRATOINI, vFContratoIni);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VFCONTRATOFIN, vFContratoFin);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VCODASESOR, vCodAsesor);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VTIPODOC, vTipoDoc);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VNUMDOC, vNumDoc);
        filterRequest.addFilterVariable(SolicitudConstants.VAR_NAME_FSOLICITUDSTATUSAFIL3_VOREGIONAL, voRegional);
