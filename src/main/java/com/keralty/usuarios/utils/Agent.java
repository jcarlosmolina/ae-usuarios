...
import com.keralty.usuarios.persistence.IEntity;
import com.keralty.usuarios.persistence.oid.IOid;
...
import com.keralty.usuarios.security.User;
import com.keralty.usuarios.security.UserCrudService;
        ...
        try {
            ...
            if (currentAgentInstance == null) {
                Class<?> classFacet = Class
                        .forName("com.keralty.usuarios.persistence." + facetName);
