...
import com.keralty.usuarios.viewmodel.solicitudnovedad.crud.SolicitudNovedadPostViewModel;
import com.keralty.usuarios.viewmodel.solicitudnovedad.crud.SolicitudNovedadPutViewModel;
...
public class SolicitudNovedadService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolicitudNovedadCon getDSSolicitudNovedadCon(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolicitudNovedadCon(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoContrato getDSSolNovTipoContrato(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoContrato(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContratante getDSSolNovContratante(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContratante(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovObservaciones getDSSolNovObservaciones(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovObservaciones(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoTitular getDSSolNovTipoTitular(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoTitular(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatus getDSSolNovEstatus(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatus(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoUsuario getDSSolNovTipoUsuario(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoUsuario(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContraTipoTitular getDSSolNovContraTipoTitular(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContraTipoTitular(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.ICSolicitudNovedad getICSolicitudNovedad(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.ICSolicitudNovedad(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAfiliacion getDSSolNovEstatusAfiliacion(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAfiliacion(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAsesor getDSSolNovEstatusAsesor(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        SolicitudNovedad instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAsesor(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoContrato iIUSolNovTipoContrato(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoContrato(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContratante iIUSolNovContratante(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContratante(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovObservaciones iIUSolNovObservaciones(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovObservaciones(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoTitular iIUSolNovTipoTitular(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoTitular(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoUsuario iIUSolNovTipoUsuario(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovTipoUsuario(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContratante iIUSolNovContratanteSL(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContratante(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContraTipoTitular iIUSolNovContraTipoTitular(SolicitudNovedadOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovContraTipoTitular(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolicitudNovedadCon> piuPIUConsultaSolicitudNovedad(QueryRequest queryRequest) {
        return solveSolicitudNovedadTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolicitudNovedadCon::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatus> piuPIUEstatusSolNov(QueryRequest queryRequest) {
        return solveSolicitudNovedadTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatus::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAfiliacion> piuPIUEstatusSolNovAfiliacion(QueryRequest queryRequest) {
        return solveSolicitudNovedadTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAfiliacion::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAsesor> piuPIUEstatusSolNovAsesor(QueryRequest queryRequest) {
        return solveSolicitudNovedadTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitudnovedad.ds.DSSolNovEstatusAsesor::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse insSolNovUsrAfiliacion(
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.InsSolNovUsrAfiliacionRequest request) {
    ...
    public ServiceResponse insSolNovUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.InsSolNovUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse insSolNovUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.InsSolNovUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.InsSolNovUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.InsSolNovUsrAfiliacionRequest();
    ...
    public ServiceResponse delSolNovUsrAfiliacion(
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.DelSolNovUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delSolNovUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.DelSolNovUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse delSolNovUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.DelSolNovUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DelSolNovUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.DelSolNovUsrAfiliacionRequest();
