...
/**
 * Class with the constants relative to the <code>SuperAdmin</code> model class.
 */
public final class SuperAdminConstants {
    ...
    // Class
    /** <code>SuperAdmin</code> class id. */
    public static final String CLASS_ID = "Clas_1431630774272956_Alias";
    /** <code>SuperAdmin</code> class name. */
    public static final String CLASS_NAME = "SuperAdmin";
    /** <code>SuperAdmin</code> class alias. */
    public static final String CLASS_ALIAS = "Superadministrador";
    /** <code>SuperAdmin</code> class table name. */
    public static final String TBL_NAME = "SuperAdmin";

    // Default DisplaySet
    public static final String DEFAULT_DISPLAYSET = "funcionarioId,passWord";

    public static final String DSICSUPERADMIN = "IC_SuperAdmin";
    ...
    public static final String SERV_ID_CHANGEP4SSW0RD = "Clas_1431630774272956Ser_4B_Alias";
    ...
    // Inbound arguments
    /** <code>superAdminchangePasswordpthisAdmin</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPTHISADMIN = "p_thisAdmin";
    /** <code>superAdminchangePasswordpthisAdmin</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPTHISADMIN = "Clas_1431626842112800Ser_4Arg_1B_Alias";
    /** <code>superAdminchangePasswordpthisAdmin</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPTHISADMIN = "Usuario";
    /** <code>superAdminchangePasswordpOldPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPOLDP4SSW0RD = "p_OldPassword";
    /** <code>superAdminchangePasswordpOldPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPOLDP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>superAdminchangePasswordpOldPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPOLDP4SSW0RD = "Old password";
    /** <code>superAdminchangePasswordpNewPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPNEWP4SSW0RD = "p_NewPassword";
    /** <code>superAdminchangePasswordpNewPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPNEWP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>superAdminchangePasswordpNewPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_SUPERADMINCHANGEP4SSW0RDPNEWP4SSW0RD = "Nueva contraseña";
     ...
     * - If className is 'SuperAdmin', it returns the identification keys
     * - If className is a facet of the inheritance net of 'SuperAdmin', it returns the foreign keys to the table of the facet className
