...
public class MesaDeApoyoService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.mesadeapoyo.ds.DSMesaDeApoyo getDSMesaDeApoyo(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.mesadeapoyo.ds.DSMesaDeApoyo(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.mesadeapoyo.ds.DSMesaDeApoyo> piuPIUMesaDeApoyo(QueryRequest queryRequest) {
        return solveMesaDeApoyoTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.mesadeapoyo.ds.DSMesaDeApoyo::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse changePassword(
            com.keralty.usuarios.viewmodel.mesadeapoyo.siu.ChangePasswordRequest request) {
    ...
    public ServiceResponse changePasswordTxn(
            com.keralty.usuarios.viewmodel.mesadeapoyo.siu.ChangePasswordRequest request) throws ModelException {
