...
import com.keralty.usuarios.repository.LogHistoricoPlanesJpaRepository;
...
import com.keralty.usuarios.viewmodel.loghistoricoplanes.crud.LogHistoricoPlanesPostViewModel;
...
public class LogHistoricoPlanesService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.loghistoricoplanes.ds.DSLogHistoricoPlanes getDSLogHistoricoPlanes(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.loghistoricoplanes.ds.DSLogHistoricoPlanes(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.loghistoricoplanes.ds.DSLogHistoricoPlanes> piuPIULogHistoricoPlanes(QueryRequest queryRequest) {
        return solveLogHistoricoPlanesTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.loghistoricoplanes.ds.DSLogHistoricoPlanes::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse crear(
            com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.CrearRequest request) {
    ...
    public ServiceResponse crearTxn(
            com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.CrearRequest request) throws ModelException {
    ...
    public ServiceResponse tNEW(
            com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.TNEWRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tNEWTxn(
            com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.TNEWRequest request) throws ModelException {
    ...
    public ServiceResponse tNEWImplementation(
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.CrearRequest step10Request = new com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.CrearRequest();
            ...
            com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.CrearRequest step11Request = new com.keralty.usuarios.viewmodel.loghistoricoplanes.siu.CrearRequest();
