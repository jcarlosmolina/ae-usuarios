...
import com.keralty.usuarios.repository.RegionalJpaRepository;
...
/**
 * Persistent representation of the <code>RespRegional</code> model class.
 * <p>
 * Model Class: <code>RespRegional</code><br>
 */
@Entity(name = RespRegionalConstants.CLASS_NAME)
@Table(name = RespRegionalConstants.TBL_NAME)
public class RespRegional extends AbstractAppEntity {
    @JsonIgnore
    ...
    @Id
    @Column(name = RespRegionalConstants.FLD_FUNCIONARIOID, insertable = false, updatable = false )
    @JsonProperty(value="id")
    private Long funcionarioId;

    @Column(name = RespRegionalConstants.FLD_P4SSW0RD )
    ...
    /** Related Class. */
    @OneToOne(fetch = FetchType.LAZY, mappedBy = RespRegionalConstants.ROLE_INVNAME_FIRMA)
    @JsonIgnore
    private Firma firma;
    ...
    @JoinColumns({
        @JoinColumn(name=RespRegionalConstants.FLD_REGIONALCODIGO, referencedColumnName=RegionalConstants.FLD_REGIONALCODIGO)
    })
    @JsonIgnore
    private Regional regional;
    /** Related attribute. */
    @Column(name = RespRegionalConstants.FLD_REGIONALCODIGO, insertable = false, updatable = false)
    ...
    @JoinColumns({
        @JoinColumn(name=RespRegionalConstants.FLD_FUNCIONARIOID, referencedColumnName=FuncionarioConstants.FLD_FUNCIONARIOID)
    })
    @JsonIgnore
    ...
    */
    ...
    /**
     * Constructor used to create instances of <code>RespRegional</code>.
     * @param oid Object Identifier of the instance of <code>RespRegional</code> to be created.
     * @throws SystemException
     */
    public RespRegional(RespRegionalOid oid) {
    ...
    */
    ...
    public Boolean getRespRegionalManual()  {
    ...
    */
    ...
    public String getRespRegionalUsuario()  {
    ...
    */
    ...
    public String getRespRegionalPrimerNombre()  {
    ...
    */
    ...
    public String getRespRegionalSegundoNombre()  {
    ...
    */
    ...
    public String getRespRegionalPrimerApellido()  {
    ...
    */
    ...
    public String getRespRegionalSegundoApellido()  {
    ...
    */
    ...
    public String getRespRegionalDrvNombreCompleto()  {
    ...
    */
    ...
    public String getRespRegionalUsuarioLDAP()  {
    ...
    */
    ...
    public String getRespRegionalEmail()  {
    ...
    */
    ...
    public String getRespRegionalCodJefe()  {
    ...
    */
    ...
    public String getRespRegionalDrvNomJefe()  {
    ...
    */
    ...
    public String getRespRegionalDrvNomAgencia()  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getRespRegionalDisponible()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Long getRespRegionalNumSolNoTerminadas()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Boolean getRespRegionalDrvEsAsesorIntegral()  {
    ...
    */
    ...
    public Boolean getRespRegionalDrvEsAfiliacion()  {
    ...
    */
    ...
    public Boolean getRespRegionalModDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getRespRegionalModificaDirector() throws SystemException  {
    ...
    */
    ...
    public Boolean getRespRegionalEsDirector() throws SystemException  {
    ...
    */
    ...
    public String getRespRegionalNumIdentificacion() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getRespRegionalEsIntegral() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getRespRegionalVerDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getRespRegionalVerDocIdentificacionPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getRespRegionalVerContratoNovedad() throws SystemException  {
    ...
    */
    ...
    public String getRespRegionalCanalComercial() throws SystemException  {
    ...
    */
    ...
    public String getRespRegionalCargo() throws SystemException  {
    ...
    */
    ...
    public String getRespRegionalEstado() throws SystemException  {
    ...
    */
    ...
    public Boolean getRespRegionalAccesoValidadorUsuarios() throws SystemException  {
    ...
    */
     ...
     * Model Relationship:
     * <code>[Firma] Firma 0:1  ------ 0:1  RespRegional [RespRegional]</code>
     *
    ...
    public Firma getFirma() {
        if (firma == null) {
            List<Firma> collection = firmaRepository.findByRespRegional(this);
    ...
    */
     ...
     * Model Relationship:
     * <code>[Solicitud] Solicitudes 0:M  ------ 1:1  Agente [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesAfiliacion 0:M  ------ 0:1  UsrAfiliacion [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ReportesProcAlm] Reportes 0:M  ------ 0:M  Funcionarios [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolicitudesNovedad 0:M  ------ 1:1  Agente [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolNovAifliaciones 0:M  ------ 0:1  UsrAfiliacion [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[GrupoAsignacion] GrupoAsignacion 0:M  ------ 0:M  Funcionario [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogFuncionario] LogFuncionario 0:M  ------ 1:1  Funcionario [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ContratoC] ContratosC 0:M  ------ 0:1  AsesorC [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[AgentexProducto] AgentexProducto 0:M  ------ 1:1  Asesor [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogInformacionAsesor] LogInformacionAsesor 0:M  ------ 1:1  Asesor [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogHistoricoPlanes] LogHistoricoPlanes 0:M  ------ 1:1  Asesor [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesArMe 0:M  ------ 0:1  UsrAreaMedica [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Regional] Regional 0:1  ------ 0:1  RespRegional [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
    ...
    public Regional getRegional() {
        ...
        if (regional == null) {
            if (regionalCodigo != null) {
                regional = regionalRepository.findById(regionalCodigo).orElse(null);
            } else {
                regional = null;
            }
        }
    ...
    */
    public void add2Regional(Regional regional) {
        if (regional == null || regional.isNull()) {
            ...
            this.regionalCodigo = regional.getRegionalCodigo();
        }
    ...
    */
     ...
     * Model Relationship:
     * <code>[Rol] Rol 1:1  ------ 0:M  Agentes [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Sucursal] Sucursal 1:1  ------ 0:M  Agentes [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[TipoIdentificacion] TipoIdentificacion 0:1  ------ 0:M  Asesores [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Planes] Planes 0:M  ------ 0:M  Afiliaciones [RespRegional]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
    ...
    public Funcionario getParentFuncionario() {
        if (!parentFuncionarioInitialized) {
            setParentFuncionario(respRegionalRepository.findParent(getFuncionarioId()));
        }
    ...
    protected Method[] getMethods() {
    	return RespRegional.class.getMethods();
    }
    ...
    protected String getClassAttributeType(String attribute) {
    	return RespRegionalConstants.ATTRIBUTE_TYPES.get(attribute.toUpperCase());
    }
    ...
    */
    ...
    /**
     * Returns the <code>RespRegionalOid</code> object that identifies this instance of <code>RespRegional</code>.
     * @return <code>RespRegionalOid </code> object that identifies this instance of <code>RespRegional</code>
     */
    public RespRegionalOid getOid() {
        return new RespRegionalOid(getFuncionarioId());
    }

    
    @Override
    protected boolean isAttributeVisible(String item) {
        return getAgent().isAnyFacetActive(RespRegionalConstants.ATTRIBUTE_AGENTS.get(item.toUpperCase()));
    }


    @Override
    protected boolean isRelatedItemVerticallyVisible(String item) {
        return getSerCtx().getAgent().isAnyFacetActive(RespRegionalConstants.ROLE_AGENTS.get(item.toUpperCase()));
    }
    ...
    public List<String> getFacets() {
        ...
        if (!activeFacets.contains(Constants.RESPREGIONAL)) {
            // Add this class
            activeFacets.add(Constants.RESPREGIONAL);
        }
        return activeFacets;
    }
    ...
    */
    public boolean checkHorizontalVisibility(IEntity agent) {
        ...
        if (getAgent().isFacetActive(Constants.AGENT_RESPREGIONAL)) {
            ...
            */
            try {
                if (agentInstance.equalsObject(this)) {
                    returnValue = true;
                }
            } catch (Exception e) {
            	returnValue = false;
    ...
    public String buildICRespRegional() {
        try {
            return getFuncionariodrvNombreCompleto();
        } catch(Exception e) {
            return "";
    ...
    public String buildDSRespRegionalPIU() {
        try {
            return getFuncionarioUsuario() + " " + getFuncionarioPrimerNombre() + " " + getFuncionarioSegundoNombre() + " " + getFuncionarioPrimerApellido() + " " + getFuncionarioSegundoApellido() + " " + getFuncionarioEmail() + " " + getFuncionarioUsuarioLDAP() + " " + getRegional().getRegionalDescripcion();
        } catch(Exception e) {
            return "";
        }
    }

    public String buildICRespRegionalNomApe() {
        try {
    ...
    public String buildDSRespRegional() {
        try {
            return getFuncionariodrvNombreCompleto();
        } catch(Exception e) {
            return "";
