...
public class AdminOid implements IOid {
     ...
     */
    public AdminOid(Long funcionarioId) {
     ...
     */
    public AdminOid(List<Object> col) {
     ...
     */
    public AdminOid(FuncionarioOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof AdminOid)) {
            returnValue = false;
        } else {
            AdminOid oid = (AdminOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = AdminConstants.ATTR_NAME_FUNCIONARIOID;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return AdminConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        AdminOid candidateOID = null;
        try {
            candidateOID = new AdminOid((Long) instance[0]);
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public AdminOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        AdminOid temp;
        try {
            temp = mapper.readValue(jsonString, AdminOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
