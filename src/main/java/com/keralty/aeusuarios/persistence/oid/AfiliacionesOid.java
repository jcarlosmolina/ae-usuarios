...
public class AfiliacionesOid implements IOid {
     ...
     */
    public AfiliacionesOid(Long funcionarioId) {
     ...
     */
    public AfiliacionesOid(List<Object> col) {
     ...
     */
    public AfiliacionesOid(FuncionarioOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof AfiliacionesOid)) {
            returnValue = false;
        } else {
            AfiliacionesOid oid = (AfiliacionesOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = AfiliacionesConstants.ATTR_NAME_FUNCIONARIOID;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return AfiliacionesConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        AfiliacionesOid candidateOID = null;
        try {
            candidateOID = new AfiliacionesOid((Long) instance[0]);
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public AfiliacionesOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        AfiliacionesOid temp;
        try {
            temp = mapper.readValue(jsonString, AfiliacionesOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
