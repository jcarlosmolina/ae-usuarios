...
import com.keralty.usuarios.viewmodel.regional.crud.RegionalPostViewModel;
import com.keralty.usuarios.viewmodel.regional.crud.RegionalPutViewModel;
...
public class RegionalService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.regional.ds.ICRegional getICRegional(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.regional.ds.ICRegional(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.regional.ds.AutoDS getAutoDS(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Regional instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.regional.ds.AutoDS(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.regional.ds.AutoDS> piuPIURegional(QueryRequest queryRequest) {
        return solveRegionalTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.regional.ds.AutoDS::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse crear(
            com.keralty.usuarios.viewmodel.regional.siu.CrearRequest request) {
    ...
    public ServiceResponse crearTxn(
            com.keralty.usuarios.viewmodel.regional.siu.CrearRequest request) throws ModelException {
    ...
    public ServiceResponse insRegionalResponsable(
            com.keralty.usuarios.viewmodel.regional.siu.InsRegionalResponsableRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse insRegionalResponsableTxn(
            com.keralty.usuarios.viewmodel.regional.siu.InsRegionalResponsableRequest request) throws ModelException {
    ...
    public ServiceResponse insRegionalResponsableImplementation(
            com.keralty.usuarios.viewmodel.regional.siu.InsRegionalResponsableRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.respregional.siu.InsRegionalResponsableRequest relatedRequest = new com.keralty.usuarios.viewmodel.respregional.siu.InsRegionalResponsableRequest();
    ...
    public ServiceResponse cambRegionalSucursal(
            com.keralty.usuarios.viewmodel.regional.siu.CambRegionalSucursalRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse cambRegionalSucursalTxn(
            com.keralty.usuarios.viewmodel.regional.siu.CambRegionalSucursalRequest request) throws ModelException {
    ...
    public ServiceResponse cambRegionalSucursalImplementation(
            com.keralty.usuarios.viewmodel.regional.siu.CambRegionalSucursalRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest relatedRequest = new com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest();
    ...
    public ServiceResponse delRegionalResponsable(
            com.keralty.usuarios.viewmodel.regional.siu.DelRegionalResponsableRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delRegionalResponsableTxn(
            com.keralty.usuarios.viewmodel.regional.siu.DelRegionalResponsableRequest request) throws ModelException {
    ...
    public ServiceResponse delRegionalResponsableImplementation(
            com.keralty.usuarios.viewmodel.regional.siu.DelRegionalResponsableRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.respregional.siu.DelRegionalResponsableRequest relatedRequest = new com.keralty.usuarios.viewmodel.respregional.siu.DelRegionalResponsableRequest();
