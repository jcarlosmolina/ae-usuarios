...
public class FDirectores {
    ...
    public FilterRequest buildFilterRequest() {
        ...
        filterRequest.setName(AsesorConstants.FILTER_NAME_FDIRECTORES);
        filterRequest.addFilterVariable(AsesorConstants.VAR_NAME_FDIRECTORES_VUSUARIO, vUsuario);
        filterRequest.addFilterVariable(AsesorConstants.VAR_NAME_FDIRECTORES_VPRIMERNOMBRE, vPrimerNombre);
        filterRequest.addFilterVariable(AsesorConstants.VAR_NAME_FDIRECTORES_VSEGUNDONOMBRE, vSegundoNombre);
        filterRequest.addFilterVariable(AsesorConstants.VAR_NAME_FDIRECTORES_VPRIMERAPELLIDO, vPrimerApellido);
        filterRequest.addFilterVariable(AsesorConstants.VAR_NAME_FDIRECTORES_VSEGUNDOAPELLIDO, vSegundoApellido);
