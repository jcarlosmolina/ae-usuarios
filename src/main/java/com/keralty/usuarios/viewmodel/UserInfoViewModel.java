package com.keralty.usuarios.viewmodel;

import java.util.ArrayList;
import java.util.List;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.keralty.usuarios.persistence.GridPreferences;
import com.keralty.usuarios.utils.DynamicPermissionsUtils;
...
public class UserInfoViewModel {
    ...
    @JsonProperty("oidJson")
    private String oidJson;
	...
	public String getOidJson() {
		return oidJson;
	}

	public void setOidJson(String oidJson) {
		this.oidJson = oidJson;
	}
