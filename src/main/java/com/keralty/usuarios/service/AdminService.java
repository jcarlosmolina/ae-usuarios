...
public class AdminService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.admin.ds.ICAdmin getICAdmin(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.admin.ds.ICAdmin(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.admin.ds.AutoDS getAutoDS(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Admin instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.admin.ds.AutoDS(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.admin.ds.AutoDS> piuPIUAdmin(QueryRequest queryRequest) {
        return solveAdminTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.admin.ds.AutoDS::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse changePassword(
            com.keralty.usuarios.viewmodel.admin.siu.ChangePasswordRequest request) {
    ...
    public ServiceResponse changePasswordTxn(
            com.keralty.usuarios.viewmodel.admin.siu.ChangePasswordRequest request) throws ModelException {
