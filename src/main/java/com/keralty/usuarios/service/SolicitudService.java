...
import com.keralty.usuarios.viewmodel.solicitud.crud.SolicitudPostViewModel;
import com.keralty.usuarios.viewmodel.solicitud.crud.SolicitudPutViewModel;
...
public class SolicitudService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIURadicado getDSSolicitudPIURadicado(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIURadicado(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUConsultaRad getDSSolicitudPIUConsultaRad(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUConsultaRad(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUEnvioDoc getDSSolicitudPIUEnvioDoc(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUEnvioDoc(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUNuevaAfil getDSSolicitudIIUNuevaAfil(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUNuevaAfil(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratNAT getDSSolicitudIIUInfoContratNAT(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratNAT(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratJUR getDSSolicitudIIUInfoContratJUR(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratJUR(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoObservacion getDSSolicitudIIUInfoObservacion(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoObservacion(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoPago getDSSolicitudIIUInfoPago(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoPago(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.ICSolicitud getICSolicitud(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.ICSolicitud(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInclusion getDSSolicitudIIUInclusion(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInclusion(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudVacia getDSSolicitudVacia(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudVacia(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUDifLiq getDSSolicitudIIUDifLiq(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUDifLiq(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUPreexistencias getDSSolicitudIIUPreexistencias(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUPreexistencias(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFull getDSSolicitudPIUStatusFull(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFull(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFullAse getDSSolicitudPIUStatusFullAse(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFullAse(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAdmin getDSSolicitudPIUStatusAdmin(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAdmin(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAfil getDSSolicitudPIUStatusAfil(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAfil(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAreaMe getDSSolicitudPIUStatusAreaMe(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAreaMe(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAsesor getDSSolicitudPIUStatusAsesor(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAsesor(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusGestMesa getDSSolicitudPIUStatusGestMesa(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusGestMesa(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudInfoContratanteID getDSSolicitudInfoContratanteID(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudInfoContratanteID(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContraConta getDSSolicitudIIUInfoContraConta(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Solicitud instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContraConta(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUNuevaAfil iIUNuevaAfiliacion(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUNuevaAfil(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratJUR iIUInfoContratanteJUR(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratJUR(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoObservacion iIUInfoObservaciones(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoObservacion(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoPago iIUInfoPago(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoPago(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInclusion iIUInclusion(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInclusion(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudInfoContratanteID iIUInfoContratanteIDINCL(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudInfoContratanteID(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContraConta iIUInfoContratanteContactoINC(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContraConta(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudVacia iIUSolicitudVacia(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudVacia(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUDifLiq iIUDiferenciasLiquidacion(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUDifLiq(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUPreexistencias iIUSolicitudPreexistencias(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUPreexistencias(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.ICSolicitud iIUInfoContratanteEditable(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.ICSolicitud(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.ICSolicitud iIUInfoTitularEditable(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.ICSolicitud(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratNAT iIUInfoContratanteNAT(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratNAT(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratJUR iIUInfoContratanteJURCol(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratJUR(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratNAT iIUInfoContratanteNATCol(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudIIUInfoContratNAT(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFull iIUSolicitudEstatusVerMas(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFull(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFullAse iIUSolicitudEstatusVerMasAse(SolicitudOid oid) {
        return new com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusFullAse(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIURadicado> piuPIURadicados(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIURadicado::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUConsultaRad> piuPIUConsultarRadicado(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUConsultaRad::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUEnvioDoc> piuPIUEnvioDoc(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUEnvioDoc::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAdmin> piuPIUEstatusSolicitudesAdmin(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAdmin::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAfil> piuPIUEstatusSolicitudesAfil(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAfil::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAreaMe> piuPIUEstatusSolicitudesAreaMed(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAreaMe::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAsesor> piuPIUEstatusSolicitudesAsesor(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusAsesor::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusGestMesa> piuPIUEstatusSolGestorMesa(QueryRequest queryRequest) {
        return solveSolicitudTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.solicitud.ds.DSSolicitudPIUStatusGestMesa::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse insUsrAreaMedica(
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAreaMedicaRequest request) {
    ...
    public ServiceResponse insUsrAreaMedicaTxn(
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAreaMedicaRequest request) throws ModelException {
    ...
    public ServiceResponse insUsrAreaMedicaImplementation(
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAreaMedicaRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.areamedica.siu.InsUsrAreaMedicaRequest relatedRequest = new com.keralty.usuarios.viewmodel.areamedica.siu.InsUsrAreaMedicaRequest();
    ...
    public ServiceResponse delUsrAreaMedica(
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAreaMedicaRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delUsrAreaMedicaTxn(
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAreaMedicaRequest request) throws ModelException {
    ...
    public ServiceResponse delUsrAreaMedicaImplementation(
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAreaMedicaRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.areamedica.siu.DelUsrAreaMedicaRequest relatedRequest = new com.keralty.usuarios.viewmodel.areamedica.siu.DelUsrAreaMedicaRequest();
    ...
    public ServiceResponse insUsrAfiliacion(
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse insUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse insUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.InsUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.InsUsrAfiliacionRequest();
    ...
    public ServiceResponse delUsrAfiliacion(
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse delUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DelUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.DelUsrAfiliacionRequest();
