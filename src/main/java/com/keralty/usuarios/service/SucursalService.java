...
import com.keralty.usuarios.service.SucursalService;
...
import com.keralty.usuarios.viewmodel.sucursal.crud.SucursalPostViewModel;
import com.keralty.usuarios.viewmodel.sucursal.crud.SucursalPutViewModel;
...
public class SucursalService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.sucursal.ds.ICSucursal getICSucursal(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.sucursal.ds.ICSucursal(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.sucursal.ds.DSSucursalPIU getDSSucursalPIU(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Sucursal instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.sucursal.ds.DSSucursalPIU(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.sucursal.ds.DSSucursalPIU> piuPIUSucursal(QueryRequest queryRequest) {
        return solveSucursalTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.sucursal.ds.DSSucursalPIU::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse crear(
            com.keralty.usuarios.viewmodel.sucursal.siu.CrearRequest request) {
    ...
    public ServiceResponse crearTxn(
            com.keralty.usuarios.viewmodel.sucursal.siu.CrearRequest request) throws ModelException {
    ...
    public ServiceResponse sincronizar(
            com.keralty.usuarios.viewmodel.sucursal.siu.SincronizarRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse sincronizarTxn(
            com.keralty.usuarios.viewmodel.sucursal.siu.SincronizarRequest request) throws ModelException {
    ...
    public ServiceResponse cambRegionalSucursal(
            com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse cambRegionalSucursalTxn(
            com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest request) throws ModelException {
    ...
    public ServiceResponse cambRegionalSucursalImplementation(
            com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.regional.siu.CambRegionalSucursalRequest relatedRequest = new com.keralty.usuarios.viewmodel.regional.siu.CambRegionalSucursalRequest();
    ...
    public ServiceResponse cambSucursalAgente(
            com.keralty.usuarios.viewmodel.sucursal.siu.CambSucursalAgenteRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse cambSucursalAgenteTxn(
            com.keralty.usuarios.viewmodel.sucursal.siu.CambSucursalAgenteRequest request) throws ModelException {
    ...
    public ServiceResponse cambSucursalAgenteImplementation(
            com.keralty.usuarios.viewmodel.sucursal.siu.CambSucursalAgenteRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.funcionario.siu.CambSucursalAgenteRequest relatedRequest = new com.keralty.usuarios.viewmodel.funcionario.siu.CambSucursalAgenteRequest();
    ...
    public ServiceResponse tSINCRONIZAR(
            com.keralty.usuarios.viewmodel.sucursal.siu.TSINCRONIZARRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tSINCRONIZARTxn(
            com.keralty.usuarios.viewmodel.sucursal.siu.TSINCRONIZARRequest request) throws ModelException {
    ...
    public ServiceResponse tSINCRONIZARImplementation(
        ...
        com.keralty.usuarios.viewmodel.sucursal.siu.SincronizarRequest step1Request = new com.keralty.usuarios.viewmodel.sucursal.siu.SincronizarRequest();
        ...
        if (guard2) {
            com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest step2Request = new com.keralty.usuarios.viewmodel.sucursal.siu.CambRegionalSucursalRequest();
