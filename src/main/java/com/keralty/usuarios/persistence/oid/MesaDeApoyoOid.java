...
public class MesaDeApoyoOid implements IOid {
     ...
     */
    public MesaDeApoyoOid(Long funcionarioId) {
     ...
     */
    public MesaDeApoyoOid(List<Object> col) {
     ...
     */
    public MesaDeApoyoOid(FuncionarioOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof MesaDeApoyoOid)) {
            returnValue = false;
        } else {
            MesaDeApoyoOid oid = (MesaDeApoyoOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = MesaDeApoyoConstants.ATTR_NAME_FUNCIONARIOID;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return MesaDeApoyoConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        MesaDeApoyoOid candidateOID = null;
        try {
            candidateOID = new MesaDeApoyoOid((Long) instance[0]);
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public MesaDeApoyoOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        MesaDeApoyoOid temp;
        try {
            temp = mapper.readValue(jsonString, MesaDeApoyoOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
