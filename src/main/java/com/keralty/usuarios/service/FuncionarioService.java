...
import com.keralty.usuarios.sqlutils.SQLWhereNegation;
...
import com.keralty.usuarios.sqlutils.SQLWhereOperandThis;
...
public class FuncionarioService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.funcionario.ds.ICAgente getICAgente(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.funcionario.ds.ICAgente(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU getDSAgentePIU(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Funcionario instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDReportes getDSFuncionarioDReportes(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Funcionario instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDReportes(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDGrupo getDSFuncionarioDGrupo(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Funcionario instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDGrupo(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.funcionario.ds.ICUsuarioLDAP getICUsuarioLDAP(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Funcionario instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.funcionario.ds.ICUsuarioLDAP(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU> piuPIUAgente(QueryRequest queryRequest) {
        return solveFuncionarioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDReportes> piuPIUDFuncionariosReporte(QueryRequest queryRequest) {
        return solveFuncionarioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDReportes::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDGrupo> piuPIUFuncionarioDGrupo(QueryRequest queryRequest) {
        return solveFuncionarioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDGrupo::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDGrupo> piuPIUFuncionarioDDominio(QueryRequest queryRequest) {
        return solveFuncionarioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.funcionario.ds.DSFuncionarioDGrupo::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU> piuPIUFuncionarioGrupoUsuarios(QueryRequest queryRequest) {
        return solveFuncionarioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU> piuPIUUsuarios(QueryRequest queryRequest) {
        return solveFuncionarioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.funcionario.ds.DSAgentePIU::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse crear(
            com.keralty.usuarios.viewmodel.funcionario.siu.CrearRequest request) {
    ...
    public ServiceResponse crearTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.CrearRequest request) throws ModelException {
    ...
    public ServiceResponse eliminar(
            com.keralty.usuarios.viewmodel.funcionario.siu.EliminarRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse eliminarTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.EliminarRequest request) throws ModelException {
    ...
    public ServiceResponse modificar(
            com.keralty.usuarios.viewmodel.funcionario.siu.ModificarRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse modificarTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.ModificarRequest request) throws ModelException {
    ...
    public ServiceResponse setPassword(
            com.keralty.usuarios.viewmodel.funcionario.siu.SetPasswordRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse setPasswordTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.SetPasswordRequest request) throws ModelException {
    ...
    public ServiceResponse hacerAdmin(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAdminRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerAdminTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAdminRequest request) throws ModelException {
    ...
    public ServiceResponse hacerSuperAdmin(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerSuperAdminRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerAsesor(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAsesorRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse sincronizarAsesor(
            com.keralty.usuarios.viewmodel.funcionario.siu.SincronizarAsesorRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse sincronizarAsesorTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.SincronizarAsesorRequest request) throws ModelException {
    ...
    public ServiceResponse hacerRespRegional(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerRespRegionalRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerRespRegionalTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerRespRegionalRequest request) throws ModelException {
    ...
    public ServiceResponse hacerAreaMedica(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAreaMedicaRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerAfiliaciones(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAfiliacionesRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerAfiliacionesTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAfiliacionesRequest request) throws ModelException {
    ...
    public ServiceResponse cambSucursalAgente(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambSucursalAgenteRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse cambSucursalAgenteTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambSucursalAgenteRequest request) throws ModelException {
    ...
    public ServiceResponse cambSucursalAgenteImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambSucursalAgenteRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.sucursal.siu.CambSucursalAgenteRequest relatedRequest = new com.keralty.usuarios.viewmodel.sucursal.siu.CambSucursalAgenteRequest();
    ...
    public ServiceResponse deshacerAdmin(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAdminRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerAdminTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAdminRequest request) throws ModelException {
    ...
    public ServiceResponse deshacerSuperAdmin(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerSuperAdminRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerAsesor(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAsesorRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerRespRegional(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerRespRegionalRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerRespRegionalTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerRespRegionalRequest request) throws ModelException {
    ...
    public ServiceResponse deshacerAreaMedica(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAreaMedicaRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerAfiliaciones(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAfiliacionesRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerAfiliacionesTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAfiliacionesRequest request) throws ModelException {
    ...
    public ServiceResponse cambRolAgente(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambRolAgenteRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse cambRolAgenteTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambRolAgenteRequest request) throws ModelException {
    ...
    public ServiceResponse cambRolAgenteImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambRolAgenteRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.rol.siu.CambRolAgenteRequest relatedRequest = new com.keralty.usuarios.viewmodel.rol.siu.CambRolAgenteRequest();
    ...
    public ServiceResponse modAsesorAgencia(
            com.keralty.usuarios.viewmodel.funcionario.siu.ModAsesorAgenciaRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse modAsesorAgenciaTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.ModAsesorAgenciaRequest request) throws ModelException {
    ...
    public ServiceResponse insReporteFuncionario(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsReporteFuncionarioRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse insReporteFuncionarioTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsReporteFuncionarioRequest request) throws ModelException {
    ...
    public ServiceResponse insReporteFuncionarioImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsReporteFuncionarioRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.reportesprocalm.siu.InsReporteFuncionarioRequest relatedRequest = new com.keralty.usuarios.viewmodel.reportesprocalm.siu.InsReporteFuncionarioRequest();
    ...
    public ServiceResponse delReporteFuncionario(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelReporteFuncionarioRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delReporteFuncionarioTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelReporteFuncionarioRequest request) throws ModelException {
    ...
    public ServiceResponse delReporteFuncionarioImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelReporteFuncionarioRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.reportesprocalm.siu.DelReporteFuncionarioRequest relatedRequest = new com.keralty.usuarios.viewmodel.reportesprocalm.siu.DelReporteFuncionarioRequest();
    ...
    public ServiceResponse addFuncionarioGrupo(
            com.keralty.usuarios.viewmodel.funcionario.siu.AddFuncionarioGrupoRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse addFuncionarioGrupoTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.AddFuncionarioGrupoRequest request) throws ModelException {
    ...
    public ServiceResponse addFuncionarioGrupoImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.AddFuncionarioGrupoRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.AddFuncionarioGrupoRequest relatedRequest = new com.keralty.usuarios.viewmodel.grupoasignacion.siu.AddFuncionarioGrupoRequest();
    ...
    public ServiceResponse delFuncionarioGrupo(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelFuncionarioGrupoRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delFuncionarioGrupoTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelFuncionarioGrupoRequest request) throws ModelException {
    ...
    public ServiceResponse delFuncionarioGrupoImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelFuncionarioGrupoRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.grupoasignacion.siu.DelFuncionarioGrupoRequest relatedRequest = new com.keralty.usuarios.viewmodel.grupoasignacion.siu.DelFuncionarioGrupoRequest();
    ...
    public ServiceResponse insSolNovUsrAfiliacion(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsSolNovUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse insSolNovUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsSolNovUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse insSolNovUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsSolNovUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.InsSolNovUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.solicitudnovedad.siu.InsSolNovUsrAfiliacionRequest();
    ...
    public ServiceResponse delSolNovUsrAfiliacion(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelSolNovUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delSolNovUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelSolNovUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse delSolNovUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelSolNovUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.solicitudnovedad.siu.DelSolNovUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.solicitudnovedad.siu.DelSolNovUsrAfiliacionRequest();
    ...
    public ServiceResponse insUsrAfiliacion(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse insUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse insUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.InsUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.solicitud.siu.InsUsrAfiliacionRequest();
    ...
    public ServiceResponse delUsrAfiliacion(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelUsrAfiliacionRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delUsrAfiliacionTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelUsrAfiliacionRequest request) throws ModelException {
    ...
    public ServiceResponse delUsrAfiliacionImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.DelUsrAfiliacionRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAfiliacionRequest relatedRequest = new com.keralty.usuarios.viewmodel.solicitud.siu.DelUsrAfiliacionRequest();
    ...
    public ServiceResponse cambiarDisponible(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambiarDisponibleRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse cambiarDisponibleTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.CambiarDisponibleRequest request) throws ModelException {
    ...
    public ServiceResponse solicitudAsignada(
            com.keralty.usuarios.viewmodel.funcionario.siu.SolicitudAsignadaRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse solicitudAsignadaTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.SolicitudAsignadaRequest request) throws ModelException {
    ...
    public ServiceResponse solicitudTerminada(
            com.keralty.usuarios.viewmodel.funcionario.siu.SolicitudTerminadaRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse solicitudTerminadaTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.SolicitudTerminadaRequest request) throws ModelException {
    ...
    public ServiceResponse hacerGestor(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerGestorRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerGestor(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerGestorRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerMesaApoyo(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerMesaApoyoRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse hacerMesaApoyoTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerMesaApoyoRequest request) throws ModelException {
    ...
    public ServiceResponse deshacerMesaApoyo(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerMesaApoyoRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse deshacerMesaApoyoTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerMesaApoyoRequest request) throws ModelException {
    ...
    public ServiceResponse tCREAR(
            com.keralty.usuarios.viewmodel.funcionario.siu.TCREARRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tCREARTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.TCREARRequest request) throws ModelException {
    ...
    public ServiceResponse tCREARImplementation(
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.CrearRequest step1Request = new com.keralty.usuarios.viewmodel.funcionario.siu.CrearRequest();
        ...
        if (ifCondition2) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAdminRequest step20Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAdminRequest();
        ...
        if (ifCondition3) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerSuperAdminRequest step30Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerSuperAdminRequest();
        ...
        if (ifCondition4) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAreaMedicaRequest step40Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAreaMedicaRequest();
        ...
        if (ifCondition5) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAfiliacionesRequest step50Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAfiliacionesRequest();
        ...
        if (ifCondition6) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerRespRegionalRequest step60Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerRespRegionalRequest();
        ...
        if (ifCondition7) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerGestorRequest step70Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerGestorRequest();
        ...
        if (ifCondition8) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerMesaApoyoRequest step80Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerMesaApoyoRequest();
    ...
    public ServiceResponse tMODIFICARYROL(
            com.keralty.usuarios.viewmodel.funcionario.siu.TMODIFICARYROLRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tMODIFICARYROLTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.TMODIFICARYROLRequest request) throws ModelException {
    ...
    public ServiceResponse tMODIFICARYROLImplementation(
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.ModificarRequest step1Request = new com.keralty.usuarios.viewmodel.funcionario.siu.ModificarRequest();
        ...
        if (ifCondition2) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAdminRequest step20Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAdminRequest();
        ...
        if (ifCondition3) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerSuperAdminRequest step30Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerSuperAdminRequest();
        ...
        if (ifCondition4) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAreaMedicaRequest step40Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAreaMedicaRequest();
        ...
        if (ifCondition5) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAfiliacionesRequest step50Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerAfiliacionesRequest();
        ...
        if (ifCondition6) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerRespRegionalRequest step60Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerRespRegionalRequest();
        ...
        if (ifCondition7) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerGestorRequest step70Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerGestorRequest();
        ...
        if (ifCondition8) {
            com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerMesaApoyoRequest step80Request = new com.keralty.usuarios.viewmodel.funcionario.siu.DeshacerMesaApoyoRequest();
        ...
        if (ifCondition9) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAdminRequest step90Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAdminRequest();
        ...
        if (ifCondition10) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerSuperAdminRequest step100Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerSuperAdminRequest();
        ...
        if (ifCondition11) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAreaMedicaRequest step110Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAreaMedicaRequest();
        ...
        if (ifCondition12) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerAfiliacionesRequest step120Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAfiliacionesRequest();
        ...
        if (ifCondition13) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerRespRegionalRequest step130Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerRespRegionalRequest();
        ...
        if (ifCondition14) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerGestorRequest step140Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerGestorRequest();
        ...
        if (ifCondition15) {
            com.keralty.usuarios.viewmodel.funcionario.siu.HacerMesaApoyoRequest step150Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerMesaApoyoRequest();
        ...
        if (ifCondition16) {
            com.keralty.usuarios.viewmodel.funcionario.siu.CambRolAgenteRequest step160Request = new com.keralty.usuarios.viewmodel.funcionario.siu.CambRolAgenteRequest();
    ...
    public ServiceResponse tCREARASESOR(
            com.keralty.usuarios.viewmodel.funcionario.siu.TCREARASESORRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tCREARASESORTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.TCREARASESORRequest request) throws ModelException {
    ...
    public ServiceResponse tCREARASESORImplementation(
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.HacerAsesorRequest step2Request = new com.keralty.usuarios.viewmodel.funcionario.siu.HacerAsesorRequest();
     ...
     */
    @Transactional(Transactional.TxType.NOT_SUPPORTED)
    public com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse tNEWASESORMANUAL(
            com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALRequest request) {
        com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse response = new com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse();
        try {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRES_NEW)
    public com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse tNEWASESORMANUALTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALRequest request) throws ModelException {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRED)
    public com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse tNEWASESORMANUALImplementation(
            com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALRequest request) throws ModelException {
        com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse response = new com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse();
    ...
    public ServiceResponse tCAMBIARDISPONIBLE(
            com.keralty.usuarios.viewmodel.funcionario.siu.TCAMBIARDISPONIBLERequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tCAMBIARDISPONIBLETxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.TCAMBIARDISPONIBLERequest request) throws ModelException {
    ...
    public ServiceResponse tCAMBIARDISPONIBLEImplementation(
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.CambiarDisponibleRequest step1Request = new com.keralty.usuarios.viewmodel.funcionario.siu.CambiarDisponibleRequest();
        ...
        com.keralty.usuarios.viewmodel.logfuncionario.siu.TCREARRequest step2Request = new com.keralty.usuarios.viewmodel.logfuncionario.siu.TCREARRequest();
    ...
    public ServiceResponse tBORRAR(
            com.keralty.usuarios.viewmodel.funcionario.siu.TBORRARRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tBORRARTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.TBORRARRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tBORRARImplementation(
        ...
        for(LogFuncionario step1Entity : repository.assocOperator000(funcionarioTBORRARpthisFuncionario)) {
            com.keralty.usuarios.viewmodel.logfuncionario.siu.EliminarRequest step1Request = new com.keralty.usuarios.viewmodel.logfuncionario.siu.EliminarRequest();
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.EliminarRequest step2Request = new com.keralty.usuarios.viewmodel.funcionario.siu.EliminarRequest();
     ...
     */
    public ServiceResponse tBORRARCheckPreconditions(com.keralty.usuarios.viewmodel.funcionario.siu.TBORRARRequest request) {
        ServiceResponse response = new ServiceResponse();
        request.setFuncionarioTBORRARpthisFuncionarioInstance(funcionarioSrv.getByOIDWithHV(request.getFuncionarioTBORRARpthisFuncionario()));
        try {
    ...
    public ServiceResponse changePassword(
            com.keralty.usuarios.viewmodel.funcionario.siu.ChangePasswordRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse changePasswordTxn(
            com.keralty.usuarios.viewmodel.funcionario.siu.ChangePasswordRequest request) throws ModelException {
