...
public class AreaMedicaOid implements IOid {
     ...
     */
    public AreaMedicaOid(Long funcionarioId) {
     ...
     */
    public AreaMedicaOid(List<Object> col) {
     ...
     */
    public AreaMedicaOid(FuncionarioOid parentOID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null) {
            returnValue = false;
        } else if (!(obj instanceof AreaMedicaOid)) {
            returnValue = false;
        } else {
            AreaMedicaOid oid = (AreaMedicaOid) obj;
            if (oid == this) {
                returnValue = true;
            } else {
    ...
    public String[] getKeys() {
        ...
        values[0] = AreaMedicaConstants.ATTR_NAME_FUNCIONARIOID;
        return values;
    }
    ...
    public String getDefinitionClass() {
        return AreaMedicaConstants.CLASS_NAME;
    }
    ...
    public boolean compareToRS(Object[] instance) {
        ...
        AreaMedicaOid candidateOID = null;
        try {
            candidateOID = new AreaMedicaOid((Long) instance[0]);
        } catch (Exception e) {
            hasError = true;
        }
    ...
    public AreaMedicaOid fromJsonString(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        AreaMedicaOid temp;
        try {
            temp = mapper.readValue(jsonString, AreaMedicaOid.class);
        } catch (Exception e) {
            temp = null;
        }
        if (temp != null) {
