...
/**
 * Persistent representation of the <code>SuperAdmin</code> model class.
 * <p>
 * Model Class: <code>SuperAdmin</code><br>
 */
@Entity(name = SuperAdminConstants.CLASS_NAME)
@Table(name = SuperAdminConstants.TBL_NAME)
public class SuperAdmin extends AbstractAppEntity {
    @JsonIgnore
    private static final long serialVersionUID = 1L;

    @JsonIgnore
    private transient SuperAdminJpaRepository superAdminRepository;

    /** Class identification function. */
    @Id
    @Column(name = SuperAdminConstants.FLD_FUNCIONARIOID, insertable = false, updatable = false )
    @JsonProperty(value="id")
    private Long funcionarioId;

    @Column(name = SuperAdminConstants.FLD_P4SSW0RD )
    ...
    @JoinColumns({
        @JoinColumn(name=SuperAdminConstants.FLD_FUNCIONARIOID, referencedColumnName=FuncionarioConstants.FLD_FUNCIONARIOID)
    })
    @JsonIgnore
    ...
    */
    ...
    /**
     * Constructor used to create instances of <code>SuperAdmin</code>.
     * @param oid Object Identifier of the instance of <code>SuperAdmin</code> to be created.
     * @throws SystemException
     */
    public SuperAdmin(SuperAdminOid oid) {
    ...
    */
    ...
    public Boolean getSuperAdminManual()  {
    ...
    */
    ...
    public String getSuperAdminUsuario()  {
    ...
    */
    ...
    public String getSuperAdminPrimerNombre()  {
    ...
    */
    ...
    public String getSuperAdminSegundoNombre()  {
    ...
    */
    ...
    public String getSuperAdminPrimerApellido()  {
    ...
    */
    ...
    public String getSuperAdminSegundoApellido()  {
    ...
    */
    ...
    public String getSuperAdminDrvNombreCompleto()  {
    ...
    */
    ...
    public String getSuperAdminUsuarioLDAP()  {
    ...
    */
    ...
    public String getSuperAdminCodJefe()  {
    ...
    */
    ...
    public String getSuperAdminDrvNomJefe()  {
    ...
    */
    ...
    public String getSuperAdminDrvNomAgencia()  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getSuperAdminDisponible()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Long getSuperAdminNumSolNoTerminadas()  {
...
Indica el número de solicitudes no terminadas que tiene asignadas el usuario. Se utilizará en los procesos de asignación automática de usuarios a solicitudes<br>
    ...
    */
    ...
    public Boolean getSuperAdminDrvEsAsesorIntegral()  {
    ...
    */
    ...
    public Boolean getSuperAdminDrvEsAfiliacion()  {
    ...
    */
    ...
    public Boolean getSuperAdminModDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getSuperAdminModificaDirector() throws SystemException  {
    ...
    */
    ...
    public Boolean getSuperAdminEsDirector() throws SystemException  {
    ...
    */
    ...
    public String getSuperAdminNumIdentificacion() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getSuperAdminEsIntegral() throws SystemException  {
...
RADIO=1;
    ...
    */
    ...
    public Boolean getSuperAdminVerDBasicosPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getSuperAdminVerDocIdentificacionPersona() throws SystemException  {
    ...
    */
    ...
    public Boolean getSuperAdminVerContratoNovedad() throws SystemException  {
    ...
    */
    ...
    public String getSuperAdminCanalComercial() throws SystemException  {
    ...
    */
    ...
    public String getSuperAdminCargo() throws SystemException  {
    ...
    */
    ...
    public String getSuperAdminEstado() throws SystemException  {
    ...
    */
    ...
    public Boolean getSuperAdminAccesoValidadorUsuarios() throws SystemException  {
    ...
    */
     ...
     * Model Relationship:
     * <code>[Solicitud] Solicitudes 0:M  ------ 1:1  Agente [SuperAdmin]</code>
     *
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesAfiliacion 0:M  ------ 0:1  UsrAfiliacion [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ReportesProcAlm] Reportes 0:M  ------ 0:M  Funcionarios [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolicitudesNovedad 0:M  ------ 1:1  Agente [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[SolicitudNovedad] SolNovAifliaciones 0:M  ------ 0:1  UsrAfiliacion [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[GrupoAsignacion] GrupoAsignacion 0:M  ------ 0:M  Funcionario [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogFuncionario] LogFuncionario 0:M  ------ 1:1  Funcionario [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[ContratoC] ContratosC 0:M  ------ 0:1  AsesorC [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[AgentexProducto] AgentexProducto 0:M  ------ 1:1  Asesor [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogInformacionAsesor] LogInformacionAsesor 0:M  ------ 1:1  Asesor [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[LogHistoricoPlanes] LogHistoricoPlanes 0:M  ------ 1:1  Asesor [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Solicitud] SolicitudesArMe 0:M  ------ 0:1  UsrAreaMedica [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Firma] Firma 0:1  ------ 0:1  RespRegional [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Rol] Rol 1:1  ------ 0:M  Agentes [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Sucursal] Sucursal 1:1  ------ 0:M  Agentes [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[TipoIdentificacion] TipoIdentificacion 0:1  ------ 0:M  Asesores [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Planes] Planes 0:M  ------ 0:M  Afiliaciones [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
     ...
     * Model Relationship:
     * <code>[Regional] Regional 0:1  ------ 0:1  RespRegional [SuperAdmin]</code>
     *
     * @throws SystemException if there is any error on having gotten a related instance.
    ...
    public Funcionario getParentFuncionario() {
        if (!parentFuncionarioInitialized) {
            setParentFuncionario(superAdminRepository.findParent(getFuncionarioId()));
        }
    ...
    private void initAttributes() {
        ...
        values = new HashMap<>();
        superAdminRepository = Arc.container().select(SuperAdminJpaRepository.class).get();
    ...
    protected Method[] getMethods() {
    	return SuperAdmin.class.getMethods();
    }
    ...
    protected String getClassAttributeType(String attribute) {
    	return SuperAdminConstants.ATTRIBUTE_TYPES.get(attribute.toUpperCase());
    }
    ...
    */
    ...
    /**
     * Returns the <code>SuperAdminOid</code> object that identifies this instance of <code>SuperAdmin</code>.
     * @return <code>SuperAdminOid </code> object that identifies this instance of <code>SuperAdmin</code>
     */
    public SuperAdminOid getOid() {
        return new SuperAdminOid(getFuncionarioId());
    }

    
    @Override
    protected boolean isAttributeVisible(String item) {
        return getAgent().isAnyFacetActive(SuperAdminConstants.ATTRIBUTE_AGENTS.get(item.toUpperCase()));
    }


    @Override
    protected boolean isRelatedItemVerticallyVisible(String item) {
        return getSerCtx().getAgent().isAnyFacetActive(SuperAdminConstants.ROLE_AGENTS.get(item.toUpperCase()));
    }
    ...
    public List<String> getFacets() {
        ...
        if (!activeFacets.contains(Constants.SUPERADMIN)) {
            // Add this class
            activeFacets.add(Constants.SUPERADMIN);
        }
        return activeFacets;
    }
    ...
    */
    ...
    public String buildICSuperAdmin() {
        try {
