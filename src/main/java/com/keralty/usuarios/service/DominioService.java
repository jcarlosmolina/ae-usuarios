...
import com.keralty.usuarios.viewmodel.dominio.crud.DominioPostViewModel;
import com.keralty.usuarios.viewmodel.dominio.crud.DominioPutViewModel;
...
public class DominioService extends AbstractService {
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.ICDominio getICDominio(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        ...
        return new com.keralty.usuarios.viewmodel.dominio.ds.ICDominio(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioPIU getDSDominioPIU(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioPIU(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioIIU getDSDominioIIU(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioIIU(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioFirmaRespClausulado getDSDominioFirmaRespClausulado(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioFirmaRespClausulado(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioSolNovedad getDSDominioSolNovedad(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioSolNovedad(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAsesores getDSDominioMGrupoAsesores(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAsesores(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAreaMedica getDSDominioMGrupoAreaMedica(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAreaMedica(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGruposUsuarios getDSDominioMGruposUsuarios(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGruposUsuarios(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominiosPorAsesor getDSDominiosPorAsesor(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominiosPorAsesor(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMLog getDSDominioMLog(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMLog(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioDIncompatibles getDSDominioDIncompatibles(String instanceOid, String relatedInstancePath, String relatedInstanceDomain) {
        Dominio instance = (relatedInstancePath.isEmpty() ? 
                getByJsonOid(instanceOid):
                getByRelated(buildRelatedInstance(instanceOid, relatedInstancePath), relatedInstancePath).get(0));
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioDIncompatibles(instance);
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioIIU iIUDominio(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioIIU(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioFirmaRespClausulado iIUDominioFirma(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioFirmaRespClausulado(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioSolNovedad iIUDominioDSolNovedad(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioSolNovedad(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAsesores iIUDominioMGrupoAsesores(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAsesores(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAreaMedica iIUDominioMGrupoAreaMedica(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGrupoAreaMedica(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGruposUsuarios iIUDominioMGruposUsuarios(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMGruposUsuarios(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMLog iIUDominioMIncompatibles(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMLog(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMLog iIUDominioMLogDatos(DominioOid oid) {
        return new com.keralty.usuarios.viewmodel.dominio.ds.DSDominioMLog(getByOIDWithHV(oid));
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.dominio.ds.DSDominioPIU> piuPIUDominio(QueryRequest queryRequest) {
        return solveDominioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.dominio.ds.DSDominioPIU::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.dominio.ds.DSDominiosPorAsesor> piuPIUDominiosPorAsesor(QueryRequest queryRequest) {
        return solveDominioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.dominio.ds.DSDominiosPorAsesor::new)
                .collect(Collectors.toList());
    }
     ...
     */
    @Transactional(Transactional.TxType.SUPPORTS)
    public List<com.keralty.usuarios.viewmodel.dominio.ds.DSDominioDIncompatibles> piuPIUDominioDIncompatibles(QueryRequest queryRequest) {
        return solveDominioTypedQuery(queryRequest).stream()
                .map(com.keralty.usuarios.viewmodel.dominio.ds.DSDominioDIncompatibles::new)
                .collect(Collectors.toList());
    }
    ...
    public ServiceResponse insRolDominio(
            com.keralty.usuarios.viewmodel.dominio.siu.InsRolDominioRequest request) {
    ...
    public ServiceResponse insRolDominioTxn(
            com.keralty.usuarios.viewmodel.dominio.siu.InsRolDominioRequest request) throws ModelException {
    ...
    public ServiceResponse insRolDominioImplementation(
            com.keralty.usuarios.viewmodel.dominio.siu.InsRolDominioRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.rol.siu.InsRolDominioRequest relatedRequest = new com.keralty.usuarios.viewmodel.rol.siu.InsRolDominioRequest();
    ...
    public ServiceResponse delRollDominio(
            com.keralty.usuarios.viewmodel.dominio.siu.DelRollDominioRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delRollDominioTxn(
            com.keralty.usuarios.viewmodel.dominio.siu.DelRollDominioRequest request) throws ModelException {
    ...
    public ServiceResponse delRollDominioImplementation(
            com.keralty.usuarios.viewmodel.dominio.siu.DelRollDominioRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.rol.siu.DelRollDominioRequest relatedRequest = new com.keralty.usuarios.viewmodel.rol.siu.DelRollDominioRequest();
    ...
    public ServiceResponse insDominio(
            com.keralty.usuarios.viewmodel.dominio.siu.InsDominioRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse insDominioTxn(
            com.keralty.usuarios.viewmodel.dominio.siu.InsDominioRequest request) throws ModelException {
    ...
    public ServiceResponse insDominioImplementation(
            com.keralty.usuarios.viewmodel.dominio.siu.InsDominioRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.agentexproducto.siu.InsDominioRequest relatedRequest = new com.keralty.usuarios.viewmodel.agentexproducto.siu.InsDominioRequest();
    ...
    public ServiceResponse delDominio(
            com.keralty.usuarios.viewmodel.dominio.siu.DelDominioRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delDominioTxn(
            com.keralty.usuarios.viewmodel.dominio.siu.DelDominioRequest request) throws ModelException {
    ...
    public ServiceResponse delDominioImplementation(
            com.keralty.usuarios.viewmodel.dominio.siu.DelDominioRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.agentexproducto.siu.DelDominioRequest relatedRequest = new com.keralty.usuarios.viewmodel.agentexproducto.siu.DelDominioRequest();
