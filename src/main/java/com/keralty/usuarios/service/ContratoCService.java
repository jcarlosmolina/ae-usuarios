...
import com.keralty.usuarios.viewmodel.contratoc.crud.ContratoCPostViewModel;
import com.keralty.usuarios.viewmodel.contratoc.crud.ContratoCPutViewModel;
...
public class ContratoCService extends AbstractService {
    ...
    public ServiceResponse insAsesorC(
            com.keralty.usuarios.viewmodel.contratoc.siu.InsAsesorCRequest request) {
    ...
    public ServiceResponse insAsesorCTxn(
            com.keralty.usuarios.viewmodel.contratoc.siu.InsAsesorCRequest request) throws ModelException {
    ...
    public ServiceResponse insAsesorCImplementation(
            com.keralty.usuarios.viewmodel.contratoc.siu.InsAsesorCRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.asesor.siu.InsAsesorCRequest relatedRequest = new com.keralty.usuarios.viewmodel.asesor.siu.InsAsesorCRequest();
    ...
    public ServiceResponse delAsesorC(
            com.keralty.usuarios.viewmodel.contratoc.siu.DelAsesorCRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse delAsesorCTxn(
            com.keralty.usuarios.viewmodel.contratoc.siu.DelAsesorCRequest request) throws ModelException {
    ...
    public ServiceResponse delAsesorCImplementation(
            com.keralty.usuarios.viewmodel.contratoc.siu.DelAsesorCRequest request, boolean isEntryPoint) throws ModelException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (isEntryPoint) {
            com.keralty.usuarios.viewmodel.asesor.siu.DelAsesorCRequest relatedRequest = new com.keralty.usuarios.viewmodel.asesor.siu.DelAsesorCRequest();
