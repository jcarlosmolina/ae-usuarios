...
/**
 * Class with the constants relative to the <code>Admin</code> model class.
 */
public final class AdminConstants {
    ...
    // Class
    /** <code>Admin</code> class id. */
    public static final String CLASS_ID = "Clas_1431630774272861_Alias";
    /** <code>Admin</code> class name. */
    public static final String CLASS_NAME = "Admin";
    /** <code>Admin</code> class alias. */
    public static final String CLASS_ALIAS = "Administrador";
    /** <code>Admin</code> class table name. */
    public static final String TBL_NAME = "Admin";

    // Default DisplaySet
    public static final String DEFAULT_DISPLAYSET = "funcionarioId,passWord";

    public static final String DSICADMIN = "IC_Admin";
    ...
    public static final String SERV_ID_CHANGEP4SSW0RD = "Clas_1431630774272861Ser_4B_Alias";
    ...
    // Inbound arguments
    /** <code>adminchangePasswordpthisAdmin</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPTHISADMIN = "p_thisAdmin";
    /** <code>adminchangePasswordpthisAdmin</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPTHISADMIN = "Clas_1431626842112800Ser_4Arg_1B_Alias";
    /** <code>adminchangePasswordpthisAdmin</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPTHISADMIN = "Usuario";
    /** <code>adminchangePasswordpOldPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPOLDP4SSW0RD = "p_OldPassword";
    /** <code>adminchangePasswordpOldPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPOLDP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>adminchangePasswordpOldPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPOLDP4SSW0RD = "Old password";
    /** <code>adminchangePasswordpNewPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPNEWP4SSW0RD = "p_NewPassword";
    /** <code>adminchangePasswordpNewPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPNEWP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>adminchangePasswordpNewPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_ADMINCHANGEP4SSW0RDPNEWP4SSW0RD = "Nueva contraseña";
     ...
     * - If className is 'Admin', it returns the identification keys
     * - If className is a facet of the inheritance net of 'Admin', it returns the foreign keys to the table of the facet className
