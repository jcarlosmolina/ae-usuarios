...
/**
 * Class with the constants relative to the <code>MesaDeApoyo</code> model class.
 */
public final class MesaDeApoyoConstants {

    private MesaDeApoyoConstants() {

    }

    // Class
    /** <code>MesaDeApoyo</code> class id. */
    public static final String CLASS_ID = "Clas_1624269783040652_Alias";
    /** <code>MesaDeApoyo</code> class name. */
    public static final String CLASS_NAME = "MesaDeApoyo";
    /** <code>MesaDeApoyo</code> class alias. */
    public static final String CLASS_ALIAS = "Mesa de apoyo";
    /** <code>MesaDeApoyo</code> class table name. */
    public static final String TBL_NAME = "MesaDeApoyo";

    // Default DisplaySet
    public static final String DEFAULT_DISPLAYSET = "funcionarioId,passWord";

    public static final String DSDSMESADEAPOYO = "DS_MesaDeApoyo";
    ...
    public static final String SERV_ID_CHANGEP4SSW0RD = "Clas_1624269783040652Ser_4B_Alias";
    ...
    // Inbound arguments
    /** <code>mesaDeApoyochangePasswordpthisAdmin</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPTHISADMIN = "p_thisAdmin";
    /** <code>mesaDeApoyochangePasswordpthisAdmin</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPTHISADMIN = "Clas_1431626842112800Ser_4Arg_1B_Alias";
    /** <code>mesaDeApoyochangePasswordpthisAdmin</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPTHISADMIN = "Usuario";
    /** <code>mesaDeApoyochangePasswordpOldPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPOLDP4SSW0RD = "p_OldPassword";
    /** <code>mesaDeApoyochangePasswordpOldPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPOLDP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>mesaDeApoyochangePasswordpOldPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPOLDP4SSW0RD = "Old password";
    /** <code>mesaDeApoyochangePasswordpNewPassword</code> inbound argument name. */
    public static final String ARG_NAME_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPNEWP4SSW0RD = "p_NewPassword";
    /** <code>mesaDeApoyochangePasswordpNewPassword</code> inbound argument id. */
    public static final String ARG_ID_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPNEWP4SSW0RD = "Clas_1431626842112800Ser_4Arg_2B_Alias";
    /** <code>mesaDeApoyochangePasswordpNewPassword</code> inbound argument alias. */
    public static final String ARG_ALIAS_CHANGEP4SSW0RD_MESADEAPOYOCHANGEP4SSW0RDPNEWP4SSW0RD = "Nueva contraseña";

    public static final String FILTER_NAME_FMESADEAPOYO = "F_MesaDeApoyo";
    public static final String VAR_NAME_FMESADEAPOYO_VFPRIMERNOMBRE = "vfPrimerNombre";
    public static final String VAR_NAME_FMESADEAPOYO_VFSEGUNDONOMBRE = "vfSegundoNombre";
    public static final String VAR_NAME_FMESADEAPOYO_VFPRIMERAPE = "vfPrimerApe";
    public static final String VAR_NAME_FMESADEAPOYO_VFSEGUNDOAPE = "vfSegundoApe";
     ...
     * - If className is 'MesaDeApoyo', it returns the identification keys
     * - If className is a facet of the inheritance net of 'MesaDeApoyo', it returns the foreign keys to the table of the facet className
