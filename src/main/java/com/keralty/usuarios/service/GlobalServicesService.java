...
import com.keralty.usuarios.repository.GlobalServicesJpaRepository;
...
public class GlobalServicesService extends AbstractService {
    ...
    public ServiceResponse tGSINC1PRODUCTOImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1PRODUCTORequest request) throws ModelException, SystemException {
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.productos.siu.CrearRequest step10Request = new com.keralty.usuarios.viewmodel.productos.siu.CrearRequest();
            ...
            for(Productos step111Entity : globalServicesRepository.assocOperator001(tGSINC1PRODUCTOptpatrNumero)) {
                com.keralty.usuarios.viewmodel.productos.siu.SincronizarRequest step11Request = new com.keralty.usuarios.viewmodel.productos.siu.SincronizarRequest();
    ...
    public ServiceResponse tGSINCPRODUCTOS(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCPRODUCTOSRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGSINCPRODUCTOSTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCPRODUCTOSRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGSINCPRODUCTOSImplementation(
        ...
        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1PRODUCTORequest step1Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1PRODUCTORequest();
        ...
        if (ifCondition2) {
            for(FrecuenciaAct step220Entity : globalServicesRepository.assocOperator003()) {
                com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest step20Request = new com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest();
            ...
            for(FrecuenciaAct step221Entity : globalServicesRepository.assocOperator004()) {
                com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest step21Request = new com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest();
    ...
    public ServiceResponse tGSINC1SUCURSALImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1SUCURSALRequest request) throws ModelException, SystemException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.regional.siu.CrearRequest step10Request = new com.keralty.usuarios.viewmodel.regional.siu.CrearRequest();
        ...
        for(Regional step2Entity : globalServicesRepository.assocOperator039(tGSINC1SUCURSALptpatrCodigo)) {
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1SUCURSALAUXRequest step2Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1SUCURSALAUXRequest();
    ...
    public ServiceResponse tGSINC1SUCURSALAUXImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1SUCURSALAUXRequest request) throws ModelException, SystemException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.sucursal.siu.CrearRequest step10Request = new com.keralty.usuarios.viewmodel.sucursal.siu.CrearRequest();
            ...
            for(Sucursal step111Entity : globalServicesRepository.assocOperator042(tGSINC1SUCURSALAUXptpatrCodigo)) {
                com.keralty.usuarios.viewmodel.sucursal.siu.TSINCRONIZARRequest step11Request = new com.keralty.usuarios.viewmodel.sucursal.siu.TSINCRONIZARRequest();
    ...
    public ServiceResponse tGSINCSUCURSALES(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCSUCURSALESRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGSINCSUCURSALESTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCSUCURSALESRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGSINCSUCURSALESImplementation(
        ...
        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1SUCURSALRequest step1Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1SUCURSALRequest();
    ...
    public ServiceResponse tGSINC1ASESOR(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGSINC1ASESORTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGSINC1ASESORImplementation(
        ...
        for(Sucursal step1Entity : globalServicesRepository.assocOperator063(tGSINC1ASESORptpatrCodigoSucursal)) {
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORAUXRequest step1Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORAUXRequest();
    ...
    public ServiceResponse tGSINC1ASESORAUXImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORAUXRequest request) throws ModelException, SystemException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.funcionario.siu.TCREARASESORRequest step10Request = new com.keralty.usuarios.viewmodel.funcionario.siu.TCREARASESORRequest();
            ...
            for(Asesor step1111Entity : globalServicesRepository.assocOperator065(tGSINC1ASESORAUXptpatrUsuario)) {
                com.keralty.usuarios.viewmodel.asesor.siu.TSINCRONIZARRequest step11Request = new com.keralty.usuarios.viewmodel.asesor.siu.TSINCRONIZARRequest();
            ...
            for(Asesor step1112Entity : globalServicesRepository.assocOperator066(tGSINC1ASESORAUXptpatrUsuario)) {
                com.keralty.usuarios.viewmodel.funcionario.siu.ModAsesorAgenciaRequest step12Request = new com.keralty.usuarios.viewmodel.funcionario.siu.ModAsesorAgenciaRequest();
    ...
    public ServiceResponse oGSINCASESORES(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCASESORESRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse oGSINCASESORESTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCASESORESRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse oGSINCASESORESImplementation(
        ...
        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCSUCURSALESRequest step1Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCSUCURSALESRequest();
        globalServicesSrv.tGSINCSUCURSALESImplementation(step1Request);

        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCTIPOSIDENTIFICACIONRequest step2Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCTIPOSIDENTIFICACIONRequest();
        globalServicesSrv.tGSINCTIPOSIDENTIFICACIONImplementation(step2Request);

        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORRequest step3Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1ASESORRequest();
        ...
        if (ifCondition4) {
            for(FrecuenciaAct step440Entity : globalServicesRepository.assocOperator068()) {
                com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest step40Request = new com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest();
            ...
            for(FrecuenciaAct step441Entity : globalServicesRepository.assocOperator069()) {
                com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest step41Request = new com.keralty.usuarios.viewmodel.frecuenciaact.siu.FijarSincronizacionRequest();
        ...
        com.keralty.usuarios.viewmodel.globalservices.siu.TGPOSPROCESARASESORESRequest step5Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGPOSPROCESARASESORESRequest();
        globalServicesSrv.tGPOSPROCESARASESORESImplementation(step5Request);

        com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCAGENTESXPRODRequest step6Request = new com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCAGENTESXPRODRequest();
    ...
    public ServiceResponse tGSINC1TIPOIDENTIFICACIONImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1TIPOIDENTIFICACIONRequest request) throws ModelException, SystemException {
        ServiceResponse response = new ServiceResponse();
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.tipoidentificacion.siu.CrearRequest step10Request = new com.keralty.usuarios.viewmodel.tipoidentificacion.siu.CrearRequest();
            ...
            for(TipoIdentificacion step111Entity : globalServicesRepository.assocOperator096(tGSINC1TIPOIDENTIFICACIONptpatrCodigo)) {
                com.keralty.usuarios.viewmodel.tipoidentificacion.siu.SincronizarRequest step11Request = new com.keralty.usuarios.viewmodel.tipoidentificacion.siu.SincronizarRequest();
    ...
    public ServiceResponse tGSINCTIPOSIDENTIFICACION(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCTIPOSIDENTIFICACIONRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGSINCTIPOSIDENTIFICACIONTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCTIPOSIDENTIFICACIONRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGSINCTIPOSIDENTIFICACIONImplementation(
        ...
        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1TIPOIDENTIFICACIONRequest step1Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1TIPOIDENTIFICACIONRequest();
    ...
    public ServiceResponse tGVERIFICARUSUARIO(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGVERIFICARUSUARIORequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGVERIFICARUSUARIOTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGVERIFICARUSUARIORequest request) throws ModelException, SystemException {
        ...
        if (ifCondition1) {
            ...
            if (ifCondition10) {
                for(Sucursal step1100Entity : globalServicesRepository.assocOperator139()) {
                    com.keralty.usuarios.viewmodel.funcionario.siu.TCREARRequest step100Request = new com.keralty.usuarios.viewmodel.funcionario.siu.TCREARRequest();
                ...
                for(Funcionario step1101Entity : globalServicesRepository.assocOperator140(tGVERIFICARUSUARIOptpatrUsuario)) {
                    com.keralty.usuarios.viewmodel.funcionario.siu.TMODIFICARYROLRequest step101Request = new com.keralty.usuarios.viewmodel.funcionario.siu.TMODIFICARYROLRequest();
    ...
    public ServiceResponse oGSINCAGENTESXPROD(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCAGENTESXPRODRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse oGSINCAGENTESXPRODTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGSINCAGENTESXPRODRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse oGSINCAGENTESXPRODImplementation(
        ...
        com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODRequest step1Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODRequest();
    ...
    public ServiceResponse tGSINC1AGENTEXPROD(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGSINC1AGENTEXPRODTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGSINC1AGENTEXPRODImplementation(
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCPRODUCTOSRequest step10Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINCPRODUCTOSRequest();
        ...
        for(Productos step2Entity : globalServicesRepository.assocOperator147(tGSINC1AGENTEXPRODpProducto)) {
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODAUXRequest step2Request = new com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODAUXRequest();
    ...
    public ServiceResponse tGSINC1AGENTEXPRODAUX(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODAUXRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGSINC1AGENTEXPRODAUXTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGSINC1AGENTEXPRODAUXRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGSINC1AGENTEXPRODAUXImplementation(
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.agentexproducto.siu.TCREARRequest step10Request = new com.keralty.usuarios.viewmodel.agentexproducto.siu.TCREARRequest();
            ...
            for(AgentexProducto step111Entity : globalServicesRepository.assocOperator150(tGSINC1AGENTEXPRODAUXptpagrAsesor, tGSINC1AGENTEXPRODAUXptpatrCodigo)) {
                com.keralty.usuarios.viewmodel.agentexproducto.siu.TSINCRONIZARRequest step11Request = new com.keralty.usuarios.viewmodel.agentexproducto.siu.TSINCRONIZARRequest();
    ...
    public ServiceResponse tGPOSPROCESS1ASESORImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGPOSPROCESS1ASESORRequest request) throws ModelException, SystemException {
        ServiceResponse response = new ServiceResponse();
        ...
        for(Asesor step1Entity : globalServicesRepository.assocOperator166(tGPOSPROCESS1ASESORpUsuario)) {
            com.keralty.usuarios.viewmodel.asesor.siu.TPOSPROCESOSINCRequest step1Request = new com.keralty.usuarios.viewmodel.asesor.siu.TPOSPROCESOSINCRequest();
    ...
    public ServiceResponse tGPOSPROCESARASESORES(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGPOSPROCESARASESORESRequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGPOSPROCESARASESORESTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGPOSPROCESARASESORESRequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGPOSPROCESARASESORESImplementation(
        ...
        for(Asesor step2Entity : globalServicesRepository.assocOperator169()) {
            com.keralty.usuarios.viewmodel.asesor.siu.TPOSPROCESOSINCRequest step2Request = new com.keralty.usuarios.viewmodel.asesor.siu.TPOSPROCESOSINCRequest();
    ...
    public ServiceResponse tCREARAGENTE(
            com.keralty.usuarios.viewmodel.globalservices.siu.TCREARAGENTERequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tCREARAGENTETxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TCREARAGENTERequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tCREARAGENTEImplementation(
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.TCREARRequest step1Request = new com.keralty.usuarios.viewmodel.funcionario.siu.TCREARRequest();
    ...
    public ServiceResponse tMODIFICARAGENTE(
            com.keralty.usuarios.viewmodel.globalservices.siu.TMODIFICARAGENTERequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tMODIFICARAGENTETxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TMODIFICARAGENTERequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tMODIFICARAGENTEImplementation(
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.TMODIFICARYROLRequest step1Request = new com.keralty.usuarios.viewmodel.funcionario.siu.TMODIFICARYROLRequest();
     ...
     */
    @Transactional(Transactional.TxType.NOT_SUPPORTED)
    public com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse tGNEWASESORAGENCIA(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIARequest request) {
        com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse();
        try {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRES_NEW)
    public com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse tGNEWASESORAGENCIATxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIARequest request) throws ModelException, SystemException {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRED)
    public com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse tGNEWASESORAGENCIAImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIARequest request) throws ModelException, SystemException {
        com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse();
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALRequest step1Request = new com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALRequest();
        ...
        com.keralty.usuarios.viewmodel.funcionario.siu.TNEWASESORMANUALResponse step1Response = funcionarioSrv.tNEWASESORMANUALImplementation(step1Request);
        ...
        for(Funcionario step2Entity : globalServicesRepository.assocOperator173(tGNEWASESORAGENCIAptpatrUsuario)) {
            com.keralty.usuarios.viewmodel.funcionario.siu.ModAsesorAgenciaRequest step2Request = new com.keralty.usuarios.viewmodel.funcionario.siu.ModAsesorAgenciaRequest();
     ...
     * @returns Service response viewmodel with the execution results
     */
    public com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse tGNEWASESORAGENCIACheckPreconditions(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIARequest request) {
        com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.TGNEWASESORAGENCIAResponse();
        request.setTGNEWASESORAGENCIAptpagrSucursalInstance(sucursalSrv.getByOIDWithHV(request.getTGNEWASESORAGENCIAptpagrSucursal()));
        request.setTGNEWASESORAGENCIAptpagrTipoIdentificacionInstance(tipoIdentificacionSrv.getByOIDWithHV(new TipoIdentificacionOid().fromJsonString(request.getTGNEWASESORAGENCIAptpagrTipoIdentificacion())));
    ...
    public ServiceResponse tGMODASESORAGENCIA(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGMODASESORAGENCIARequest request) {
        ServiceResponse response = new ServiceResponse();
        try {
    ...
    public ServiceResponse tGMODASESORAGENCIATxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.TGMODASESORAGENCIARequest request) throws ModelException, SystemException {
    ...
    public ServiceResponse tGMODASESORAGENCIAImplementation(
        ...
        com.keralty.usuarios.viewmodel.asesor.siu.TMODIFICARASESORAGENCIARequest step1Request = new com.keralty.usuarios.viewmodel.asesor.siu.TMODIFICARASESORAGENCIARequest();
     ...
     */
    @Transactional(Transactional.TxType.NOT_SUPPORTED)
    public com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse oGCARGAVISASESORES(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESRequest request) {
        com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse();
        try {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRES_NEW)
    public com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse oGCARGAVISASESORESTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESRequest request) throws ModelException, SystemException {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRED)
    public com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse oGCARGAVISASESORESImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESRequest request) throws ModelException, SystemException {
        com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse();
        ...
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.asesor.siu.TMODVISIBILIDADRequest step10Request = new com.keralty.usuarios.viewmodel.asesor.siu.TMODVISIBILIDADRequest();
            ...
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESRequest step11Request = new com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESRequest();
            step11Request.setOGCARGAVISASESORESptFichero(oGCARGAVISASESORESptFichero);
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAVISASESORESResponse step11Response = globalServicesSrv.oGCARGAVISASESORESImplementation(step11Request);
     ...
     */
    @Transactional(Transactional.TxType.NOT_SUPPORTED)
    public com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse oGCARGAPLANASESOR(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORRequest request) {
        com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse();
        try {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRES_NEW)
    public com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse oGCARGAPLANASESORTxn(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORRequest request) throws ModelException, SystemException {
     ...
     */
    @Transactional(Transactional.TxType.REQUIRED)
    public com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse oGCARGAPLANASESORImplementation(
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORRequest request) throws ModelException, SystemException {
        com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse response = new com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse();
        ...
        boolean ifCondition1 = Long.valueOf(1) > Long.valueOf(2);
        if (ifCondition1) {
            com.keralty.usuarios.viewmodel.asesor.siu.TCARGARDOMINIOPLANRequest step10Request = new com.keralty.usuarios.viewmodel.asesor.siu.TCARGARDOMINIOPLANRequest();
            ...
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORRequest step11Request = new com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORRequest();
            step11Request.setOGCARGAPLANASESORptFichero(oGCARGAPLANASESORptFichero);
            com.keralty.usuarios.viewmodel.globalservices.siu.OGCARGAPLANASESORResponse step11Response = globalServicesSrv.oGCARGAPLANASESORImplementation(step11Request);
